...
category: general
date: 2026-03-30
description: Verifica il conteggio delle pagine nei documenti Word mentre impari a
  recuperare file Word corrotti e a rilevare file Word corrotti usando Aspose.Words.
draft: false
keywords:
- check page count
...
- C# document loading
language: it
og_description: Verifica il numero di pagine nei documenti Word e scopri come recuperare
  un file Word corrotto con Aspose.Words. Tutorial passo‑passo in C#.
og_title: Controlla il conteggio delle pagine nei documenti Word – Guida completa
tags:
- Aspose.Words
- C#
- document processing
title: Verifica il conteggio delle pagine nei documenti Word – Recupera file corrotti
url: /it/net/programming-with-document-properties/check-page-count-in-word-docs-recover-corrupted-files/
---
