...
Aby pracować z węzłami w Aspose.Words dla .NET, programiści mogą wykorzystać Document Object Model (DOM) dostarczany przez bibliotekę. DOM przedstawia cały dokument Word jako drzewo węzłów, przy czym sam dokument jest węzłem głównym. Każdy węzeł ma określony typ węzła i może zawierać węzły podrzędne, co pozwala na głęboki poziom dostosowywania.
...
| [Pobierz węzeł nadrzędny](./get-parent-node/) Dowiedz się, jak uzyskać węzeł nadrzędny sekcji dokumentu przy użyciu Aspose.Words dla .NET, korzystając z tego szczegółowego samouczka krok po kroku. |
...
| [Wylicz węzły podrzędne](./enumerate-child-nodes/) | Dowiedz się, jak wyliczać węzły podrzędne w dokumencie programu Word za pomocą Aspose.Words dla platformy .NET, korzystając z tego samouczka krok po kroku. |
| [Dostęp wpisywany](./typed-access/) | Dowiedz się, jak używać Typed Access w Aspose.Words dla .NET, aby łatwo manipulować elementami dokumentu, takimi jak tabele i wiersze. Ten przewodnik krok po kroku upraszcza Twój przepływ pracy. |
