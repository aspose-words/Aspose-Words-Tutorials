...
W tym kroku używamy `Document` klasa z Aspose.Words do załadowania istniejącego dokumentu. Zastąp `"YOUR DOCUMENT DIRECTORY"` rzeczywistą ścieżką, pod którą przechowywany jest Twój dokument.
...
Ten krok sprawia, że stół jest starannie wyśrodkowany, co nadaje mu profesjonalny wygląd.
...
Oczyszczenie granic gwarantuje, że nowe granice zostaną zastosowane w sposób czysty, bez ingerencji starych stylów.
