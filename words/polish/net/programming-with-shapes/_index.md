...
| [Jak utworzyć prostokątny kształt i grupować kształty w Wordzie przy użyciu Aspose.Words](./how-to-create-rectangle-shape-and-group-shapes-in-word-with/) | Dowiedz się, jak w Aspose.Words dla .NET tworzyć prostokątne kształty i grupować je w dokumentach Word. |
...
| [Utwórz pusty dokument Word z cieniowanym prostokątnym kształtem – przewodnik krok po kroku](./create-blank-word-document-with-shadowed-rectangle-shape-ste/) | Dowiedz się, jak w Aspose.Words dla .NET utworzyć pusty dokument Word zawierający prostokąt z efektem cienia, krok po kroku. |
| [Utwórz pusty dokument Word i dodaj prostokątny kształt](./create-a-blank-word-document-and-add-a-rectangle-shape/) | Dowiedz się, jak w Aspose.Words dla .NET utworzyć pusty dokument Word oraz dodać do niego prostokątny kształt. |
