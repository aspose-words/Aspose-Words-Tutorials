...
| [Jak grupować kształty w Wordzie przy użyciu DocumentBuilder – przewodnik krok po kroku](./how-to-group-shapes-in-word-using-documentbuilder-step-by-st/) | Dowiedz się, jak grupować kształty w dokumencie Word przy użyciu DocumentBuilder w Aspose.Words dla .NET, krok po kroku. |
...
| [Utwórz prostokątny kształt i grupuj kształty w Wordzie przy użyciu C#](./create-rectangle-shape-and-group-shapes-in-word-using-c/) | Dowiedz się, jak tworzyć prostokątne kształty i grupować je w dokumentach Word przy użyciu Aspose.Words dla .NET i C#. |
