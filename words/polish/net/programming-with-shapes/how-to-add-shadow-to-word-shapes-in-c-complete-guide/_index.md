...
description: Jak dodać cień w C# przy użyciu Aspose.Words – dowiedz się, jak zmienić
  przezroczystość, zastosować rozmycie cienia i szybko skonfigurować cień kształtu.
draft: false
keywords:
- how to add shadow
...
language: pl
og_description: Jak dodać cień w C# przy użyciu Aspose.Words. Ten przewodnik pokazuje,
  jak zmienić przezroczystość, zastosować rozmycie cienia oraz łatwo skonfigurować
  cień kształtu.
og_title: Jak dodać cień do kształtów w Wordzie w C# – krok po kroku
schemas:
- author: Aspose
...
- Word Automation
- Shadow Effects
title: Jak dodać cień do kształtów w Wordzie w C# – Kompletny przewodnik
url: /pl/net/programming-with-shapes/how-to-add-shadow-to-word-shapes-in-c-complete-guide/
---
...
|----------|---------|----------------|
| `Visible` | Włącza lub wyłącza cień. | `true` / `false` |
| `Transparency` | Kontroluje przezroczystość. | `0.0` (nieprzezroczysty) – `1.0` (przezroczysty) |
| `BlurRadius` | Zmiękcza krawędzie cienia. | `0` (ostry) – `10+` (bardzo miękki) |
| `Distance` | Jak daleko cień jest odsunięty od kształtu. | `0` – `20` punktów |
| `Angle` | Kierunek odsunięcia w stopniach. | `0`–`360` |
| `Color` | Kolor cienia. | Dowolny `System.Drawing.Color` |
