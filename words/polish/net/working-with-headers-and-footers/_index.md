...
| [Kopiuj nagłówki i stopki z poprzedniej sekcji](./copy-headers-footers-from-previous-section/) Dowiedz się, jak kopiować nagłówki i stopki z poprzedniej sekcji w dokumentach programu Word za pomocą Aspose.Words dla platformy .NET. |
