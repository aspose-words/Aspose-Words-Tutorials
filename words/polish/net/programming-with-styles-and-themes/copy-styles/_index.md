...
Po pierwsze, musisz zdefiniować ścieżkę do katalogu dokumentów. To tutaj Aspose.Words będzie szukać Twoich plików. Zastąp `"YOUR DOCUMENT DIRECTORY"` rzeczywistą ścieżką, w której przechowywane są Twoje dokumenty.
...
### Czy mogę użyć `CopyStylesFromTemplate` z dokumentami w różnych formatach?  
...
### co jeśli dokument docelowy już ma style?  
