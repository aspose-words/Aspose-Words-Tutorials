...
- Biblioteka Aspose.Words dla .NET: Upewnij się, że masz najnowszą wersję. [Pobierz tutaj](https://releases.aspose.com/words/net/).
...
W przypadku trzeciego punktu danych `series1`, ustawiamy opcję odwracania, jeśli wartość jest ujemna, zmieniamy symbol znacznika na gwiazdkę i ustawiamy rozmiar znacznika na 20.
...
Ten wiersz zapisuje dokument w podanym przez Ciebie katalogu pod nazwą `WorkingWithCharts.SingleChartDataPoint.docx`.
