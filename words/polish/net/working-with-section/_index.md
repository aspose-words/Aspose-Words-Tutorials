...
{{< tutorial-card link="./add-section/" title="Dodaj nową sekcję do dokumentu Word" imgSrc="/words/net/working-with-section/add-section/images/thumb.png" >}}
{{< tutorial-card link="./append-section-content/" title="Dołącz i wstępnie dodaj treść do dokumentów Word" imgSrc="/words/net/working-with-section/append-section-content/images/thumb.png" >}}
