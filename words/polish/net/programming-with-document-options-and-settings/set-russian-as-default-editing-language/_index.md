...
W tym kroku należy określić ścieżkę do katalogu, w którym znajduje się dokument, i załadować dokument za pomocą `Document` konstruktor. `LoadOptions` upewnij się, że język rosyjski jest ustawiony jako domyślny język edycji.
...
### Sprawdź, czy identyfikator lokalny jest zgodny z językiem rosyjskim
