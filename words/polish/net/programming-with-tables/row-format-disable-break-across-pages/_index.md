...
tym samouczku pokażemy Ci, jak wyłączyć podział wierszy na stronach w dokumencie programu Word za pomocą pakietu Aspose.Words for .NET.
...
W tym samouczku pokazaliśmy, jak wyłączyć podział wierszy na stronach w dokumencie Word przy użyciu Aspose.Words dla .NET. Postępując zgodnie z powyższymi krokami, możesz upewnić się, że wiersze tabeli pozostaną nienaruszone i nie zostaną podzielone na stronach, zachowując czytelność i formatowanie dokumentu.
...
Możesz sprawdzić, czy wiersz umożliwia podział na strony, uzyskując dostęp do `AllowBreakAcrossPages` własność `RowFormat` i sprawdzając jego wartość.
