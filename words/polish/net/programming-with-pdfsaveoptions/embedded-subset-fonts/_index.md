...
Ten kod wygeneruje plik PDF o nazwie `WorkingWithPdfSaveOptions.EmbedSubsetFonts.pdf` określonym katalogu, z osadzonymi tylko niezbędnymi podzbiorami czcionek.
