...
2. Podstawowa wiedza o języku C#: Znajomość programowania w języku C# pomoże Ci zrozumieć przykłady kodu podane w tym samouczku.
...
Te przestrzenie nazw zapewniają dostęp do podstawowych funkcjonalności niezbędnych do manipulowania dokumentami Word i zapisywania ich w formacie PDF z różnymi opcjami.
...
### Czym jest kompresja obrazu w plikach PDF?
