...
| [Dodaj podpis cyfrowy do pliku PDF za pomocą posiadacza certyfikatu](./digitally-signed-pdf-using-certificate-holder/) | Zabezpiecz swoje pliki PDF przy użyciu podpisu cyfrowego przy użyciu Aspose.Words dla .NET. Postępuj zgodnie z tym przewodnikiem krok po kroku, aby bez wysiłku dodać podpis cyfrowy do swoich plików PDF. |
