...
### [Ustaw tryb odzyskiwania w Aspose.Words for Java – pełny przewodnik](./set-recovery-mode-in-aspose-words-for-java-full-guide/)
Dowiedz się, jak włączyć tryb odzyskiwania w Aspose.Words for Java, aby automatycznie naprawiać uszkodzone dokumenty podczas ładowania.
...
### [Zarejestruj wywołanie zwrotne ostrzeżeń w Javie – Łatwo wykryj brakujące czcionki](./register-warning-callback-in-java-detect-missing-fonts-easil/)
Dowiedz się, jak zarejestrować wywołanie zwrotne ostrzeżeń, aby automatycznie wykrywać brakujące czcionki w dokumentach przetwarzanych przez Aspose.Words for Java.
