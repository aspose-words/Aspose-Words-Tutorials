...
description: Utwórz dokument Word w Javie przy użyciu Aspose.Words. Dowiedz się, jak
  wstawić prostokątny kształt, grupować kształty w Wordzie i szybko zapisać dokument
  jako docx.
draft: false
images:
...
language: pl
lastmod: 2026-07-29
og_description: Utwórz dokument Word w Javie przy użyciu Aspose.Words. Wstaw prostokątny
  kształt, grupuj kształty w Wordzie i zapisz dokument jako docx w kilka minut.
og_image_alt: Screenshot showing how to create word document with grouped shapes using
  Java
og_title: Tworzenie dokumentu Word z kształtami – samouczek Java Aspose.Words
schemas:
- author: Aspose
...
- Java
- Word Automation
title: Utwórz dokument Word z kształtami w Javie – Kompletny przewodnik Aspose.Words
url: /pl/java/images-shapes/create-word-document-with-shapes-in-java-complete-aspose-wor/
---
