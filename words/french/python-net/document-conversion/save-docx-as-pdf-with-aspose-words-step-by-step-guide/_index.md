...
category: general
date: 2026-06-21
description: Enregistrez un docx en PDF avec Aspose.Words en Python. Apprenez à convertir
  rapidement un document Word en PDF, à exporter un document Word au format PDF et
  à créer un PDF à partir d’un document Word.
draft: false
keywords:
- save docx as pdf
- convert word to pdf
...
language: fr
og_description: Enregistrez le docx en PDF instantanément. Ce tutoriel montre comment
  exporter un document Word en PDF, convertir Word en PDF et créer un PDF à partir
...
- Python
- PDF conversion
title: Enregistrez un docx en PDF avec Aspose.Words – Guide étape par étape
url: /fr/python/document-conversion/save-docx-as-pdf-with-aspose-words-step-by-step-guide/
---
...
# Enregistrer docx en pdf avec Aspose.Words – Guide complet
...
![illustration de la sauvegarde docx en pdf](https://example.com/images/save-docx-as-pdf.png "Illustration montrant le processus de sauvegarde docx en pdf")
