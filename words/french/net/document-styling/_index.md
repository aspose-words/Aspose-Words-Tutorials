...
{{< tutorial-card link="./apply-border-and-shading/" title="Appliquer les limites et l'ombre au paragraphe dans Aspose.Words" imgSrc="/words/net/document-styling/apply-border-and-shading/images/thumb.png" >}}
{{< tutorial-card link="./apply-paragraph-style/" title="Créer et modeler un document Word dans Aspose.Words" imgSrc="/words/net/document-styling/apply-paragraph-style/images/thumb.png" >}}
{{< tutorial-card link="./multilevel-list-formatting/" title="Créer des listes à plusieurs niveaux dans Word avec Aspose.Words" imgSrc="/words/net/document-styling/multilevel-list-formatting/images/thumb.png" >}}
{{< tutorial-card link="./paragraph-formatting/" title="Formater les paragraphes à l'aide de Aspose.Words pour .NET" imgSrc="/words/net/document-styling/paragraph-formatting/images/thumb.png" >}}
