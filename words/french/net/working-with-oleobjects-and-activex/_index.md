...
| [Comment créer un contrôle ActiveX dans un document Word avec C#](./how-to-create-activex-control-in-a-word-document-with-c/) | Apprenez à créer et insérer un contrôle ActiveX dans un document Word à l'aide de C# et Aspose.Words pour .NET. |
