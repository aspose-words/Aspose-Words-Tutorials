...
| [Créer un document Word avec une forme rectangle et une ombre – Guide complet](./create-word-document-with-rectangle-shape-and-shadow-complet/) | Apprenez à créer un document Word contenant une forme rectangle avec ombre en utilisant Aspose.Words pour .NET, guide complet étape par étape. |
