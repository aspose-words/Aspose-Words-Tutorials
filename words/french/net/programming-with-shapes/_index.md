...
| [Créer une forme rectangulaire et regrouper des formes dans Word avec C#](./create-rectangle-shape-and-group-shapes-in-word-using-c/) | Apprenez à créer une forme rectangulaire et à regrouper des formes dans un document Word à l'aide d'Aspose.Words pour .NET avec C#. |
...
| [Comment regrouper des formes dans Word avec DocumentBuilder – guide étape par étape](./how-to-group-shapes-in-word-using-documentbuilder-step-by-st/) | Apprenez à regrouper des formes dans un document Word en utilisant DocumentBuilder avec Aspose.Words pour .NET, guide complet étape par étape. |
