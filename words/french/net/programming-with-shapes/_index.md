...
| [Comment insérer une balise et créer une forme de groupe dans un DOCX](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) | Apprenez à insérer une balise et à créer une forme de groupe dans un document DOCX avec Aspose.Words pour .NET. |
...
| [Comment masquer une forme dans un document Word avec du code C#](./how-to-hide-shape-in-a-word-document-with-c-code/) | Apprenez à masquer une forme dans un document Word en utilisant Aspose.Words pour .NET avec du code C#. |
