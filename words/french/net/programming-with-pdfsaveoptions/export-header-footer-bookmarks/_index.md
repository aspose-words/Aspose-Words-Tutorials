---
"description": "Découvrez comment exporter les signets d'en-tête et de pied de page d'un document Word vers PDF à l'aide d'Aspose.Words pour .NET avec notre guide étape par étape."
...
Convertir des documents Word en PDF est une tâche courante, notamment pour partager ou archiver des documents tout en préservant leur mise en forme. Ces documents contiennent parfois des signets importants dans les en-têtes et les pieds de page. Dans ce tutoriel, nous allons vous expliquer comment exporter ces signets d'un document Word vers un PDF avec Aspose.Words pour .NET.
...
Et voilà ! En suivant ces étapes, vous pouvez facilement exporter les signets des en-têtes et pieds de page d'un document Word vers un PDF avec Aspose.Words pour .NET. Cette méthode garantit la conservation des aides à la navigation importantes au format PDF, facilitant ainsi la navigation des lecteurs.
...
Vous pouvez configurer le `OutldanseOptions` in `PdfSaveOptions` pour inclure des signets du corps du document.
...
Si votre document ne contient pas de signets, le PDF sera généré sans aucun plan de signets. Assurez-vous que votre document contient des signets si vous en avez besoin dans le PDF.
