...
| [Réduire la taille du PDF en désactivant les polices intégrées](./disable-embed-windows-fonts/) Réduisez la taille de vos PDF en désactivant les polices intégrées avec Aspose.Words pour .NET. Suivez le guide étape par étape pour optimiser vos documents et les stocker et les partager efficacement. |
...
| [Créer un PDF accessible – Convertir Word en PDF avec C#](./create-accessible-pdf-convert-word-to-pdf-with-c/) | Apprenez à créer un PDF accessible en convertissant un document Word en PDF avec C# grâce à Aspose.Words pour .NET. |
