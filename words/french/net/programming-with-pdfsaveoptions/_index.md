...
| [Créer un PDF accessible en C# – Guide étape par étape](./create-accessible-pdf-in-c-step-by-step-guide/) | Apprenez à créer un PDF accessible en C# avec Aspose.Words, étape par étape, pour répondre aux normes d'accessibilité. |
...
| [Enregistrer le document au format PDF en C# – Exporter les formes en ligne](./save-document-as-pdf-in-c-export-inline-shapes/) | Apprenez à exporter les formes en ligne lors de l’enregistrement d’un document Word en PDF avec Aspose.Words pour .NET en C#. |
