...
# Recevoir une notification d'avertissement

## Introduction

Fatigué des problèmes de polices inattendus dans vos documents ? Avec Aspose.Words pour .NET, vous pouvez être averti de tout problème potentiel lors du traitement de vos documents, facilitant ainsi le maintien de leur qualité. Ce guide complet vous explique comment configurer des notifications d'avertissement dans Aspose.Words et vous assure de ne plus jamais manquer un avertissement crucial.
...
Affectez le rappel d'avertissement au document. Cela garantit que tout problème de police est détecté et consigné.
...
Enfin, enregistrez le document. Même si le document a déjà été rendu, tout avertissement d'enregistrement sera signalé à l'utilisateur lors de cette étape.
