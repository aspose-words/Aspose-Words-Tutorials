---
"description": "Découvrez comment définir des dossiers de polices système et personnalisées dans des documents Word à l'aide d'Aspose.Words pour .NET, en garantissant que vos documents s'affichent correctement dans différents environnements."
"linktitle": "Définir les dossiers de polices, le système et le dossier personnalisé"
"second_title": "API de traitement de documents Aspose.Words"
"title": "Définir les dossiers de polices, le système et le dossier personnalisé"
...
# Définir les dossiers de polices, le système et le dossier personnalisé

## Introduction

Imaginez que vous rédigez un document avec un style de police unique et que vous découvrez que les polices ne s'affichent pas correctement sur un autre ordinateur. Frustrant, n'est-ce pas ? C'est là qu'intervient la configuration des dossiers de polices. Avec Aspose.Words pour .NET, vous pouvez définir des dossiers de polices système et personnalisés pour garantir que vos documents s'affichent toujours comme prévu. Voyons comment y parvenir.
...
Pour commencer, chargez votre document Word dans un fichier Aspose.Words `Document` objet. Ce document sera celui dans lequel vous souhaiterez définir les dossiers de polices.
...
Récupérer les sources de polices système par défaut. Sur une machine Windows, cela inclut généralement le répertoire « Windows\Fonts ».
...
Ajoutez un dossier personnalisé contenant vos polices supplémentaires. Ceci est utile si vous avez des polices spécifiques qui ne sont pas installées dans le répertoire des polices système.
...
Convertissez la liste des sources de polices en un tableau et définissez-la sur `FontSettings` objet.
...
Enfin, appliquez la configuration `FontSettings` à votre document et enregistrez-le dans le format souhaité, tel que PDF.
