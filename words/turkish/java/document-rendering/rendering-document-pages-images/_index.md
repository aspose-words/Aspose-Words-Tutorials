...
Kesinlikle! Aspose.Words, görüntü işleme için çözünürlüğü ayarlamanıza olanak tanır `setResolution` yöntem `ImageSaveOptions`Bu, çıktı görüntülerinin kalite gereksinimlerinizi karşılamasını sağlar.
