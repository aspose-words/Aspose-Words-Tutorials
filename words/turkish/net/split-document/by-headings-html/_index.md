...
3. C# Temel Bilgisi: Temelleri anlamak, konuyu daha kolay takip etmenize yardımcı olacaktır.
4. Örnek Belge: Başlıklara göre bölmek istediğiniz bir Word belgeniz hazır olsun.
...
1. HtmlSaveOptions'ı Oluşturun: Örneklendirin `HtmlSaveOptions` sınıf.
2. Belge Bölme Kriterlerini Ayarla: Şunu kullanın: `DocumentSplitCriteria` Belgenin başlık paragraflarına göre bölünmesini belirten özellik.
