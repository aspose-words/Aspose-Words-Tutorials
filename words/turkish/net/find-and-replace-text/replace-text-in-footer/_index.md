...
Şimdi eski metni yeni metinle değiştirme zamanı. Bunu kullanacağız `Range.Replace` Altbilgi aralığındaki yöntemi, eski metni, yeni metni ve kurduğumuz seçenekleri belirterek.
