...
### [เปลี่ยนระยะห่างของเชิงอรรถใน DOCX – คู่มือฉบับสมบูรณ์](./change-footnote-spacing-in-docx-complete-guide/)
เรียนรู้วิธีปรับระยะห่างของเชิงอรรถในไฟล์ DOCX ด้วย Aspose.Words for Java พร้อมตัวอย่างโค้ดเต็มรูปแบบ
