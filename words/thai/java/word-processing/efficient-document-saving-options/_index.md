...
การบันทึกเอกสารในรูปแบบ DOC เป็นข้อกำหนดทั่วไป Aspose.Words สำหรับ Java จะทำให้สิ่งนี้เป็นเรื่องง่าย:
...
บางครั้งคุณอาจต้องบันทึกแต่ละหน้าของเอกสารเป็นรูปภาพ Aspose.Words สำหรับ Java จัดเตรียมเครื่องมือสำหรับการดำเนินการนี้อย่างมีประสิทธิภาพ:
