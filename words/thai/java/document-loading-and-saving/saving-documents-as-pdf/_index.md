---
"description": "เรียนรู้วิธีบันทึกเอกสาร Word เป็น PDF โดยใช้ Aspose.Words สำหรับ Java ปรับแต่งแบบอักษร คุณสมบัติ และคุณภาพของรูปภาพ คำแนะนำที่ครอบคลุมสำหรับการแปลง PDF"
...
คุณสามารถควบคุมตัวเลือกการบันทึก PDF ต่างๆ ได้โดยใช้ `PdfSaveOptions` คลาส ตัวอย่างเช่น คุณสามารถตั้งชื่อการแสดงผลสำหรับเอกสาร PDF ได้ดังนี้:
...
คุณสามารถอัปเดตคุณสมบัติ "พิมพ์ล่าสุด" ใน PDF ได้โดยการตั้งค่า `setUpdateLastPrintedProperty` ถึง `true` ใน `PdfSaveOptions`นี่จะแสดงวันที่พิมพ์ล่าสุดในข้อมูลเมตาของ PDF
