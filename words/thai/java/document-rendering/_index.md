...
### [วิธีจับคำเตือน – ตรวจจับฟอนต์ที่หายไปใน Aspose.Words](./how-to-capture-warnings-detect-missing-fonts-in-aspose-words/)
เรียนรู้วิธีดักจับคำเตือนและตรวจสอบฟอนต์ที่หายไปในเอกสาร Word ด้วย Aspose.Words for Java
