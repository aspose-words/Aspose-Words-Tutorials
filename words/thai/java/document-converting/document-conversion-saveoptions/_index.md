...
- setExportDocumentProperties(true): วิธีการนี้ช่วยให้แน่ใจว่าคุณสมบัติของเอกสารจะรวมอยู่ในไฟล์เอาต์พุต วิธีนี้มีประโยชน์อย่างยิ่งในการติดตามข้อมูลเมตาที่เกี่ยวข้องกับเอกสาร
...
คุณสามารถค้นหาการสนับสนุนและแหล่งข้อมูลเพิ่มเติมได้ใน [ฟอรั่มชุมชน Aspose](https://forum-aspose.com/c/words/8).
