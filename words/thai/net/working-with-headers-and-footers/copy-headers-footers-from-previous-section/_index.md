...
ล้างส่วนหัวและส่วนท้ายที่มีอยู่ทั้งหมดในส่วนปัจจุบันเพื่อหลีกเลี่ยงการซ้ำซ้อน
...
คุณสามารถตั้งค่าส่วนหัวและส่วนท้ายที่แตกต่างกันสำหรับหน้าคี่และหน้าคู่โดยใช้ `PageSetup.OddAndEvenPagesHeaderFooter` คุณสมบัติ.
