...
{{< tutorial-card link="./create-header-footer/" title="สร้างเอกสาร Word ด้วย Header และ Footer โดยใช้ Aspose.Words" imgSrc="/words/net/working-with-headers-and-footers/create-header-footer/images/thumb.png" >}}
{{< tutorial-card link="./insert-image/" title="ใส่ภาพในหัวข้อเอกสาร Word ครับ Aspose.Words สําหรับ .NET" imgSrc="/words/net/working-with-headers-and-footers/insert-image/images/thumb.png" >}}
