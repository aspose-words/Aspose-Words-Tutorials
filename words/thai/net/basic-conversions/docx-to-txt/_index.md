...
1. กำหนดเส้นทางไดเรกทอรีข้อมูล: ในโค้ดของคุณ กำหนดเส้นทางไปยังไดเรกทอรีเอกสารของคุณ แทนที่ `"YOUR DOCUMENT DIRECTORY"` กับเส้นทางที่แท้จริง
...
2. ตรวจสอบเอาต์พุต: หลังจากบันทึกแล้ว ตรวจสอบไดเรกทอรีเอาต์พุตเพื่อให้แน่ใจว่าไฟล์ TXT ถูกสร้างขึ้นอย่างถูกต้อง
