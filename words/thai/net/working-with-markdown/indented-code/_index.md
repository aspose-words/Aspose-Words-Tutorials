...
ทุกอย่างพร้อมแล้วใช่ไหม เยี่ยมเลย! มาต่อกันที่ส่วนที่สนุกกันเลย
...
ต่อไปเราจะกำหนดรูปแบบที่กำหนดเองสำหรับโค้ดที่ย่อหน้า รูปแบบนี้จะช่วยให้มั่นใจว่าบล็อกโค้ดของคุณมีรูปลักษณ์ที่โดดเด่น 
