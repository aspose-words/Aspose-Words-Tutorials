...
ตอนนี้เรามาดูแต่ละขั้นตอนในการกำหนดโฟลเดอร์แบบอักษรตามลำดับความสำคัญกัน
...
ใช่ คุณสามารถระบุโฟลเดอร์แบบอักษรได้หลายโฟลเดอร์ Aspose.Words ช่วยให้คุณกำหนดลำดับความสำคัญสำหรับแต่ละโฟลเดอร์ได้ เพื่อให้แน่ใจว่าจะพบแบบอักษรที่สำคัญที่สุดก่อน
