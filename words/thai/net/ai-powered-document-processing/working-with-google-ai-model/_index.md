...
ตอนนี้คุณได้นำเข้าแพ็คเกจที่จำเป็นแล้ว มาแบ่งขั้นตอนการสรุปเอกสารทีละขั้นตอนกัน
...
การ `Document` คลาสจาก Aspose.Words ช่วยให้คุณโหลดไฟล์ Word เข้าสู่หน่วยความจำได้ ตรวจสอบให้แน่ใจว่าชื่อไฟล์ตรงกับเอกสารจริงในไดเร็กทอรีของคุณ มิฉะนั้นคุณจะพบข้อผิดพลาดไม่พบไฟล์!
