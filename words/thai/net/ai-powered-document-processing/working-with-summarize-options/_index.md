...
ก่อนที่เราจะเริ่มดำเนินการสรุปเอกสาร โปรดตรวจสอบให้แน่ใจว่าคุณมีข้อกำหนดเบื้องต้นดังต่อไปนี้:
...
2. สภาพแวดล้อม .NET: ระบบของคุณต้องมีการตั้งค่าสภาพแวดล้อม .NET ไว้ (เช่น Visual Studio) หากคุณเพิ่งเริ่มใช้ .NET ก็ไม่ต้องกังวล เพราะโปรแกรมนี้ใช้งานง่ายมาก!
...
4. คีย์ API สำหรับโมเดล AI: เนื่องจากเราใช้ประโยชน์จากโมเดลภาษาสร้างสรรค์สำหรับการสรุป คุณจึงต้องใช้คีย์ API ที่คุณสามารถตั้งค่าในสภาพแวดล้อมของคุณได้
...
ขั้นต่อไปเราต้องโหลดเอกสารที่ต้องการสรุป จากนั้นเราจะนำข้อความของคุณเข้าสู่โปรแกรม
...
ตอนนี้ถึงเวลาทำงานกับโมเดล AI ของเราที่จะช่วยสรุปเอกสาร คุณจะต้องตั้งค่าคีย์ API ของคุณก่อน 
...
จะเกิดอะไรขึ้นหากคุณมีเอกสารหลายฉบับที่ต้องสรุป ไม่ต้องกังวล ขั้นตอนต่อไปนี้จะแสดงวิธีการจัดการเอกสารเหล่านี้
