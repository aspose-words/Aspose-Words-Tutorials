...
คำอธิบาย: ที่นี่เราจะสร้างอินสแตนซ์ของ `RtfSaveOptions` และตั้งค่า `SaveImagesAsWmf` ทรัพย์สินที่จะ `true`นี่จะบอก Aspose.Words ให้บันทึกรูปภาพเป็น WMF เมื่อมีการบันทึกเอกสาร
