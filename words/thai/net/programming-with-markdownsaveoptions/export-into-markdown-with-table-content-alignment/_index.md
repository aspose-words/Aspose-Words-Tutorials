...
สิ่งแรกที่เราต้องทำคือสร้างเอกสาร Word ใหม่และเริ่มต้นใช้งาน `DocumentBuilder` วัตถุที่จะเริ่มสร้างเอกสารของเรา
...
การ `Auto` ตัวเลือกการจัดตำแหน่งจะจัดตำแหน่งจากย่อหน้าแรกในคอลัมน์ของตารางที่เกี่ยวข้อง ซึ่งอาจมีประโยชน์ในกรณีที่คุณมีการจัดตำแหน่งแบบผสมในตารางเดียว
