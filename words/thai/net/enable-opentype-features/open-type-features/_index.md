...
โค้ดสั้นๆ นี้จะช่วยให้แน่ใจว่าเอกสารของคุณใช้ HarfBuzz สำหรับการจัดรูปร่างข้อความ ช่วยให้ใช้งานคุณสมบัติ OpenType ขั้นสูงได้

## ขั้นตอนที่ 4: บันทึกเอกสารของคุณ

สุดท้ายให้บันทึกเอกสารที่แก้ไขของคุณเป็น PDF เพื่อดูผลลัพธ์ของงานของคุณ
