...
เส้นนี้จะสร้างใหม่ `PdfSaveOptions` วัตถุและตั้งค่า `EmbedFullFonts` ทรัพย์สินที่จะ `true`วิธีนี้จะช่วยให้มั่นใจว่า PDF ที่สร้างขึ้นจะมีแบบอักษรทั้งหมดที่ใช้ในเอกสาร
