...
การลดขนาดไฟล์ PDF อาจมีความสำคัญต่อการจัดเก็บที่มีประสิทธิภาพและการแบ่งปันที่รวดเร็ว วิธีที่มีประสิทธิภาพวิธีหนึ่งในการทำเช่นนี้คือการปิดใช้งานฟอนต์ที่ฝังไว้ โดยเฉพาะอย่างยิ่งเมื่อฟอนต์มาตรฐานมีอยู่แล้วในระบบส่วนใหญ่ ในบทช่วยสอนนี้ เราจะมาสำรวจวิธีลดขนาดไฟล์ PDF โดยปิดใช้งานฟอนต์ที่ฝังไว้โดยใช้ Aspose.Words สำหรับ .NET เราจะอธิบายแต่ละขั้นตอนเพื่อให้แน่ใจว่าคุณสามารถนำสิ่งนี้ไปใช้ในโครงการของคุณได้อย่างง่ายดาย
...
ที่นี่, `dataDir` เป็นตัวแทนสำหรับไดเรกทอรีที่เอกสารของคุณตั้งอยู่ แทนที่ `"YOUR DOCUMENT DIRECTORY"` กับเส้นทางที่แท้จริง
