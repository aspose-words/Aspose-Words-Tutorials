...
เราสร้างอินสแตนซ์ของ `PdfSaveOptions` และตั้งค่า `Dml3DEffectsRenderingMode` ถึง `Advanced`นี่จะบอก Aspose.Words ให้เรนเดอร์เอฟเฟ็กต์ 3 มิติโดยใช้การตั้งค่าขั้นสูง เพื่อให้แน่ใจว่าดูน่าประทับใจที่สุดใน PDF
