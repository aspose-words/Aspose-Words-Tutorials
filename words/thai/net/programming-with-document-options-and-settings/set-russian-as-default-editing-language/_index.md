...
ในขั้นตอนนี้ คุณจะดึงข้อมูล `LocaleId` ของรูปแบบฟอนต์เริ่มต้นและเปรียบเทียบกับ `EditingLanguage.Russian` ตัวระบุ ข้อความเอาท์พุตจะระบุว่าภาษาเริ่มต้นถูกตั้งค่าเป็นภาษารัสเซียหรือไม่
