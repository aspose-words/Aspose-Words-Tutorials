...
เพื่อป้องกันไม่ให้ตารางแบ่งข้ามหน้า เราจำเป็นต้องตั้งค่า `KeepWithNext` คุณสมบัติสำหรับแต่ละย่อหน้าในตาราง ยกเว้นย่อหน้าสุดท้ายในแถวสุดท้าย
...
ในที่สุด เราจะบันทึกเอกสารที่อัปเดตแล้ว การดำเนินการนี้จะใช้การเปลี่ยนแปลงของเราและให้แน่ใจว่าตารางจะอยู่ด้วยกันบนหน้าเดียวกัน
...
แน่นอน! คุณสามารถจัดรูปแบบตารางตามต้องการโดยยังคงรักษาตารางให้คงอยู่บนหน้าเดียวกันได้
