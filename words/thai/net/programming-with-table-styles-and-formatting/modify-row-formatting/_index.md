...
ขั้นต่อไป เราต้องเข้าถึงตารางภายในเอกสาร Aspose.Words มีวิธีตรงไปตรงมาในการดำเนินการนี้โดยการนำทางผ่านโหนดของเอกสาร

```csharp
Table table = (Table) doc.GetChild(NodeType.Table, 0, true);
```

ที่นี่เรากำลังดึงตารางแรกในเอกสาร `GetChild` วิธีนี้ใช้เพื่อค้นหาโหนดของตารางด้วย `NodeType.Table` ระบุประเภทของโหนดที่เรากำลังมองหา `0` ระบุว่าเราต้องการตารางแรกและ `true` ทำให้แน่ใจว่าเราค้นหาเอกสารทั้งหมด
