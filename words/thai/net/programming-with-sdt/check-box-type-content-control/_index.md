...
ขั้นต่อไป คุณต้องเพิ่มการอ้างอิงไปยังไลบรารี Aspose.Words ซึ่งทำได้ผ่านตัวจัดการแพ็กเกจ NuGet ใน Visual Studio
...
ตอนนี้เรามาเริ่มเขียนโค้ดกันเลย! เราจะเริ่มต้นด้วยการสร้าง Document ใหม่และอ็อบเจ็กต์ DocumentBuilder
