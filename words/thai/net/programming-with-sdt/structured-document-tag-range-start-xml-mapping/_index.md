...
เพื่อให้แน่ใจว่าส่วน XML ได้ถูกเพิ่มอย่างถูกต้อง เราจะพิมพ์เนื้อหาของมัน
...
แท็กเอกสารที่มีโครงสร้าง (SDT) คือตัวควบคุมเนื้อหาที่สามารถผูกเข้ากับส่วน XML ได้ ที่นี่ เราสร้าง SDT ที่จะแสดงเนื้อหาของส่วน XML ที่กำหนดเองของเรา
...
ใช่ คุณสามารถเชื่อมโยงส่วน XML หลายส่วนกับ SDT ที่แตกต่างกันในเอกสารเดียวกันได้ SDT แต่ละรายการสามารถมีส่วน XML และการแมป XPath เฉพาะของตัวเองได้
