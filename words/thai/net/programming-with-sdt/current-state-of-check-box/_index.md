...
ขั้นแรก คุณต้องระบุเส้นทางไปยังเอกสาร Word ของคุณ นี่คือจุดที่ Aspose.Words จะค้นหาไฟล์เพื่อดำเนินการ Replace `"YOUR DOCUMENT DIRECTORY"` ด้วยเส้นทางจริงที่คุณเก็บเอกสารไว้
