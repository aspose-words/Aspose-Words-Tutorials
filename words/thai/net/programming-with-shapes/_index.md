...
- [สร้างรูปสี่เหลี่ยมพร้อมเงาใน Word ด้วย Aspose.Words](./create-rectangle-shape-with-shadow-in-word-using-aspose-word/) | เรียนรู้วิธีเพิ่มเงาให้รูปสี่เหลี่ยมในเอกสาร Word ด้วย Aspose.Words สำหรับ .NET พร้อมขั้นตอนและตัวอย่างโค้ด
