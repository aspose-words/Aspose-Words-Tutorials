...
| [แทรกรูปร่าง](./insert-shape/) | เรียนรู้วิธีการแทรกและจัดการรูปร่างในเอกสาร Word โดยใช้ Aspose.Words สำหรับ .NET พร้อมคู่มือทีละขั้นตอนของเรา
...
- [วิธีสร้างรูปสี่เหลี่ยมและกลุ่มรูปร่างใน Word ด้วย Aspose.Words](./how-to-create-rectangle-shape-and-group-shapes-in-word-with/) | เรียนรู้วิธีสร้างรูปสี่เหลี่ยมและจัดกลุ่มรูปร่างในเอกสาร Word ด้วย Aspose.Words สำหรับ .NET
- [เพิ่มเอฟเฟกต์เงาให้กับรูปร่างใน Word – คู่มือ C# ฉบับสมบูรณ์](./add-shadow-effect-to-word-shapes-complete-c-guide/) | เรียนรู้วิธีเพิ่มเอฟเฟกต์เงาให้กับรูปร่างในเอกสาร Word ด้วย Aspose.Words for .NET ผ่านคู่มือขั้นตอนเต็มรูปแบบใน C#
...
| [อัพเดท Smart Art Drawing](./update-smart-art-drawing/) | เรียนรู้วิธีอัปเดตภาพวาด Smart Art ในเอกสาร Word โดยใช้ Aspose.Words สำหรับ .NET ด้วยคำแนะนำทีละขั้นตอนนี้ รับรองว่าภาพของคุณจะถูกต้องเส�อ |
...
- [สร้างเอกสาร Word ว่างพร้อมรูปสี่เหลี่ยมเงา – คู่มือทีละขั้นตอน](./create-blank-word-document-with-shadowed-rectangle-shape-ste/) | เรียนรู้วิธีสร้างเอกสารว่างและเพิ่มรูปสี่เหลี่ยมที่เงาโดยใช้ Aspose.Words สำหรับ .NET ด้วยขั้นตอนง่ายๆ
- [สร้างเอกสาร Word ว่างและเพิ่มรูปสี่เหลี่ยม](./create-a-blank-word-document-and-add-a-rectangle-shape/) | เรียนรู้วิธีสร้างเอกสาร Word ว่างและเพิ่มรูปสี่เหลี่ยมโดยใช้ Aspose.Words สำหรับ .NET ผ่านขั้นตอนง่ายๆ
