...
ก่อนที่เราจะเริ่มเขียนโค้ด คุณต้องระบุเส้นทางไปยังไดเร็กทอรีเอกสารของคุณก่อน นี่คือที่ที่เอกสาร Word ที่คุณสร้างขึ้นจะถูกบันทึก
...
การ `DocumentBuilder` คลาสเป็นเครื่องมือหลักของเราสำหรับการเพิ่มเนื้อหาลงในเอกสาร ลองนึกภาพว่ามันเป็นปากกาที่เขียนบนผืนผ้าใบเอกสาร Word
...
- ชื่อ: "TextInput" - นี่คือชื่อของฟิลด์ฟอร์ม
...
สุดท้ายเราต้องบันทึกเอกสารลงในไดเร็กทอรีที่ระบุ ซึ่งจะสร้างไฟล์ .docx พร้อมช่องป้อนข้อความแบบแทรก
