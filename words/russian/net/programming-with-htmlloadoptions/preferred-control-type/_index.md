...
Здесь мы преобразуем строку HTML в массив байтов и загружаем его в документ с помощью потока памяти. Это гарантирует, что содержимое HTML будет правильно интерпретировано и отображено Aspose.Words.
