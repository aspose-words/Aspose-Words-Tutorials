...
После настройки проекта и установки необходимых пакетов перейдем к написанию кода.
