...
Для начала вам необходимо создать новый экземпляр `Document` класс и `DocumentBuilder` класс. Эти классы являются вашими точками входа для создания и обработки документов Word.
...
С `DocumentBuilder` например, вы можете начать создавать таблицу. Это делается вызовом `StartTable` метод.
