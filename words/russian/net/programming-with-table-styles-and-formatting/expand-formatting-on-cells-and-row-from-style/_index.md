...
Aspose.Words для .NET — это мощный API, позволяющий разработчикам программно создавать, редактировать, конвертировать и обрабатывать документы Word.
...
После расширения стилей они применяются непосредственно к ячейкам. Чтобы вернуться, вам нужно будет перезагрузить документ или повторно применить стили вручную.
