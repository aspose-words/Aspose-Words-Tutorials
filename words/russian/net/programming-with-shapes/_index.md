...
| [Создать прямоугольную форму и сгруппировать несколько фигур в C#](./create-rectangle-shape-and-group-multiple-shapes-in-c/) | Узнайте, как создать прямоугольную форму и объединить несколько фигур в документе Word с помощью Aspose.Words для .NET на C#. |
