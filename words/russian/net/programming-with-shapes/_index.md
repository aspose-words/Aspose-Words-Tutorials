...
| [Как группировать фигуры в C# с Aspose.Words](./how-to-group-shapes-in-c-with-aspose-words/) | Узнайте, как группировать фигуры в документах Word с помощью Aspose.Words для .NET в этом пошаговом руководстве. |
