...
| [Как вставить тег и создать групповую форму в DOCX](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) | Узнайте, как вставить тег и создать групповую форму в документе DOCX с помощью Aspose.Words для .NET. |
| [Как скрыть фигуру в документе Word с помощью C# кода](./how-to-hide-shape-in-a-word-document-with-c-code/) | Узнайте, как скрыть фигуру в документах Word с помощью Aspose.Words для .NET в этом пошаговом руководстве. |
