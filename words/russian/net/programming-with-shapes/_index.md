...
| [Создать документ Word с прямоугольной фигурой и тенью – Полное руководство](./create-word-document-with-rectangle-shape-and-shadow-complet/) | Узнайте, как добавить прямоугольную форму с тенью в документ Word с помощью Aspose.Words для .NET. |
