...
| [Как группировать фигуры в документе Word с помощью C#](./how-to-group-shapes-in-a-word-document-with-c/) | Узнайте, как группировать фигуры в документе Word с помощью C# и Aspose.Words для .NET. |
