...
Да, вы можете привязать несколько частей XML к разным SDT в одном документе. Каждый SDT может иметь свою собственную уникальную часть XML и сопоставление XPath.
