...
Используйте `Document` класс для загрузки документа Word. Этот класс позволяет открывать и манипулировать документом программно.
...
### Как создать документ Word с SDT?
