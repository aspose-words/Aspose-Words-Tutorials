...
- Библиотека Aspose.Words for .NET: если вы еще этого не сделали, загрузите ее с [здесь](https://releases.aspose.com/words/net/). Вы также можете выбрать [бесплатная пробная версия](https://releases.aspose.com/) если вы исследуете библиотеку.
...
А вот и самое интересное! Сейчас мы вставим в наш документ поле формы с флажком.
