...
{{< tutorial-card link="./create-rotated-text-table/" title="Создайте таблицу с вращённым текстом в документе Word с помощью Aspose.Words for .NET" imgSrc="./create-rotated-text-table/images/thumb.png" >}}
