...
Получив доступ `MinorFonts`, вы можете получить подробную информацию о шрифтах, используемых для различных языковых сценариев, что поможет вам обеспечить единообразие стилей на разных языках.
...
Aspose.Words for .NET — мощная библиотека для управления и обработки документов Word в приложениях .NET. Она предлагает обширные функциональные возможности для создания, редактирования и преобразования документов.
