...
| [Как создать кнопку отправки в автоматизации Word на C#](./how-to-create-submit-button-in-c-word-automation/) | Узнайте, как добавить кнопку отправки в документ Word с помощью C# и Aspose.Words. |
