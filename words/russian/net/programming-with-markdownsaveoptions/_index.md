...
| [Сохранить Word как Markdown с пользовательской папкой изображений – Полное руководство](./save-word-as-markdown-with-custom-image-folder-full-guide/) | Сохраните документ Word в формате Markdown, используя пользовательскую папку для изображений, с полным пошаговым руководством на C#. |
