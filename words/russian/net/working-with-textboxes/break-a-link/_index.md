...
Другой способ разорвать ссылку — установить `Next` свойство текстового поля `null`. Этот метод особенно полезен, когда вы динамически манипулируете структурой документа.
...
### Где я могу найти больше ресурсов по работе с Aspose.Words?
