...
# Обработка слов с комментариями
...
| [Якорь Комментарий](./anchor-comment/) | Узнайте, как добавлять комментарии-якоря в документы Word с помощью Aspose.Words для .NET. Следуйте нашему пошаговому руководству для эффективной совместной работы с документами. |
