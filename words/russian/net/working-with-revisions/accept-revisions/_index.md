...
Для начала нам нужно создать новый документ и добавить несколько абзацев. Это заложит основу для отслеживания правок.
...
На этом этапе мы создали новый документ и добавили в него три абзаца. Эти абзацы будут служить базой для нашего отслеживания изменений.
...
Позвонив по телефону `StartTrackRevisions`мы позволяем документу отслеживать все последующие изменения. Имя автора и текущая дата передаются в качестве параметров.
...
Этот шаг останавливает отслеживание новых изменений в документе и рассматривает все последующие правки как обычное содержимое.
