...
| [Как перехватывать предупреждения в C# – обнаруживать отсутствующие шрифты и вести журнал замен](./how-to-capture-warnings-in-c-detect-missing-fonts-log-substi/) | Узнайте, как перехватывать предупреждения о недостающих шрифтах и записывать их замену в Aspose.Words для .NET с помощью C#. |
...
| [Восстановление повреждённого файла Word и отображение режима восстановления в C#](./recover-corrupted-word-file-and-display-recovery-mode-in-c/) | Узнайте, как восстановить повреждённый документ Word и включить режим восстановления с помощью C# и Aspose.Words. |
