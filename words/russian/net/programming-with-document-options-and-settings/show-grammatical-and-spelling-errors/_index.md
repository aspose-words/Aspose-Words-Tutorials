...
Для начала вам нужно импортировать необходимые пространства имен. Это гарантирует, что ваш код сможет получить доступ ко всем функциям библиотеки Aspose.Words.
...
А теперь самое интересное! Вы можете включить отображение грамматических и орфографических ошибок всего парой строк кода.
