...
Теперь давайте напишем в документ текст, который мы позже заменим. Мы используем `DocumentBuilder` вставить текст "Привет _ИмяКлиента_,".
...
Вот где происходит волшебство! Мы заменим "_ИмяКлиента_"с "Джеймсом Бондом" с использованием `Replace` метод. 
...
Вы должны это увидеть._ИмяКлиента_"было заменено на "Джеймс Бонд".
