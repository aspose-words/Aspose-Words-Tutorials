...
В нашем коде мы определим каталоги для управления тем, где будут храниться наши документы и куда будут направляться наши выходные данные. 
...
## Шаг 5: Создание сводки для нескольких документов

Чувствуете авантюризм? Вы также можете суммировать несколько документов одновременно! Вот как это сделать:
