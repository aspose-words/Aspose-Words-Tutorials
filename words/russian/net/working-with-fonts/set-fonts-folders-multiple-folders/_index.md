...
Теперь наступает решающая часть — настройка папок шрифтов. Здесь вы указываете каталоги, в которых находятся ваши шрифты. В этом примере у нас есть шрифты в "C:\MyFonts" и "D:\Misc\Fonts".
