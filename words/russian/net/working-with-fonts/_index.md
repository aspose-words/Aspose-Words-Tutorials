...
| [Настройки пользовательского шрифта в C# – Загрузка Word и обработка отсутствующих шрифтов](./custom-font-settings-in-c-load-word-handle-missing-fonts/) | Узнайте, как загрузить документ Word и управлять отсутствующими шрифтами с помощью пользовательских настроек шрифтов в C#. |
