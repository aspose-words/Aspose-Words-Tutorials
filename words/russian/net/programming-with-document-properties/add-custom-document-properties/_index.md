...
Здесь мы добавляем свойство под названием "Авторизованный" со значением "Джон Смит". Вы можете заменить "Джон Смит" любым другим именем, которое вам больше нравится.
...
Эта строка добавляет свойство с именем «Авторизированная сумма» со значением `123.45`. Опять же, не стесняйтесь заменить это число на любое другое, которое соответствует вашим потребностям.
...
Безусловно! Пользовательские свойства отлично подходят для категоризации и фильтрации документов на основе определенных метаданных.
