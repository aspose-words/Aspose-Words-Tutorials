...
Чтобы объединить и добавить документы, следуйте этим шагам, гарантируя, что добавляемое содержимое начинается на новой странице:
...
### Как устранить конфликты форматирования документа во время добавления?
