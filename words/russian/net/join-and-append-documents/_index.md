---
"description": "Узнайте, как объединять и сливать документы Word с помощью Aspose.Words для .NET. Учебники проведут вас через шаги по объединению нескольких файлов Word в один документ."
...
| [Добавить с параметрами формата импорта](./append-with-import-format-options/) | Легко добавляйте документы Word с помощью Aspose.Words для .NET, сохраняя форматирование с подробными пошаговыми инструкциями. |
...
| [Сохранить исходное форматирование](./keep-source-formatting/) | Узнайте, как объединять документы Word, сохраняя форматирование с помощью Aspose.Words для .NET. Идеально подходит для разработчиков, желающих автоматизировать задачи по сборке документов. |
...
| [Список Сохранить Исходное Форматирование](./list-keep-source-formatting/) | Узнайте, как объединять документы Word, сохраняя форматирование с помощью Aspose.Words для .NET. Это руководство содержит пошаговые инструкции для бесшовного объединения документов. |
...
| [Сохраняйте исходную нумерацию](./keep-source-numbering/) Узнайте, как импортировать документы, сохраняя форматирование, с помощью Aspose.Words для .NET. Пошаговое руководство с примерами кода. |
...
| [Игнорировать верхний и нижний колонтитулы](./ignore-header-footer/) | Узнайте, как объединять документы Word, игнорируя верхние и нижние колонтитулы, с помощью Aspose.Words для .NET, с помощью этого пошагового руководства. |
