...
Да, вы можете отменить привязку верхних и нижних колонтитулов для определенных разделов, перейдя в `HeadersFooters` свойство нужного раздела и с помощью `LinkToPrevious` метод.
