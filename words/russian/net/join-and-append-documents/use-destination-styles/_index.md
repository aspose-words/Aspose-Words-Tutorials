...
Давайте разберем процесс использования стилей назначения при добавлении документов на понятные и управляемые шаги.
...
### Есть ли ограничение на количество прикрепляемых документов?
