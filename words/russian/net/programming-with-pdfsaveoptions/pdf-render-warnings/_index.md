...
"linktitle": "Предупреждения о визуализации PDF-файлов"
"second_title": "API обработки документов Aspose.Words"
"title": "Предупреждения о визуализации PDF-файлов"
...
# Предупреждения о визуализации PDF-файлов
...
Назначьте обратный вызов предупреждения документу и сохраните его как PDF. Любые предупреждения, которые возникают во время операции сохранения, будут собраны и обработаны обратным вызовом.
