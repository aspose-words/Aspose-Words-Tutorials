...
Прежде чем погрузиться в код, вам нужно настроить каталог документов. Это то место, где находится ваш пример документа Word (`Rendering.docx`) и выходной PDF-файл будет сохранен.
