...
Подумайте об этом шаге как о поиске таблицы, с которой вы хотите работать, в физическом документе. Вам нужно точно знать, где она находится, чтобы вносить какие-либо изменения.
...
Конечно! Вы можете получить доступ и задать позиции для нескольких таблиц по отдельности, перебирая `Tables` коллекция в документе.
