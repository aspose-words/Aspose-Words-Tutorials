...
Словарь переносов — это файл, содержащий правила переноса слов в соответствующих местах, улучшения компоновки текста и удобства чтения.
...
### В каких форматах файлов Aspose.Words может сохранять данные?
