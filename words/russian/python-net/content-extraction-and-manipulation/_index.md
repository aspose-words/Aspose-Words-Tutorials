...
### [Как установить обратный вызов для экспорта изображений из DOCX](./how-to-set-callback-for-exporting-images-from-docx/)
Узнайте, как задать обратный вызов при экспорте изображений из DOCX с помощью Aspose.Words для Python.
