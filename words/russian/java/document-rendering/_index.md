...
### [Генерация миниатюры документа](./document-thumbnail-generation/)
...
### [Регистрация обратного вызова предупреждений в Java – Полное руководство по программированию](./register-warning-callback-in-java-complete-programming-guide/)
Узнайте, как зарегистрировать обратный вызов предупреждений в Aspose.Words для Java, чтобы обрабатывать сообщения о предупреждениях при работе с документами.
