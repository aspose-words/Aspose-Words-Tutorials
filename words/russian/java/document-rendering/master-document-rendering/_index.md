...
Чтобы использовать Aspose.Words для Java, вам необходимо включить JAR-файл Aspose.Words в ваш проект Java. Вы можете загрузить JAR-файл из Aspose Releases(https://releases.aspose.com/words/java/) и добавить его в classpath вашего проекта.
...
### В чем разница между рендерингом и обработкой документов?
...
Aspose.Words для Java поддерживает Java версии 1.6 и более поздние.
