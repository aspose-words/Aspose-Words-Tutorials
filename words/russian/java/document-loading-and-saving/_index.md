...
### [Установить режим восстановления – Как открыть повреждённые файлы Word в Java](./set-recovery-mode-how-to-open-corrupted-word-files-in-java/)
Узнайте, как открыть повреждённые файлы Word в Java, используя режим восстановления.
