...
### [Вставка круговой диаграммы в Java с Aspose.Words – Полное руководство](./insert-pie-chart-in-java-with-aspose-words-full-guide/)
Узнайте, как вставить круговую диаграмму в документ Word с помощью Aspose.Words для Java. Пошаговое полное руководство.
...
### [Установка размера кнопки в Java – вставка кнопки ActiveX Command Button в Word](./set-button-size-java-insert-activex-command-button-in-word/)
Узнайте, как задать размер кнопки ActiveX Command Button в документе Word с помощью Aspose.Words для Java.
