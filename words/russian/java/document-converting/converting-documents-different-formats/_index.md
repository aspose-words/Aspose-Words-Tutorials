...
После загрузки Aspose.Words для Java создайте новый проект Java в предпочитаемой вами среде IDE. Добавьте JAR-файл Aspose.Words в classpath вашего проекта.
