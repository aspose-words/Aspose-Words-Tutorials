...
### Какова цель `REMOVE_UNUSED_REGIONS` вариант очистки?
...
### Что происходит, когда я устанавливаю `REMOVE_CONTAINING_FIELDS` вариант?
...
### В чем разница между `REMOVE_EMPTY_FIELDS` и `REMOVE_UNUSED_FIELDS` варианты очистки?
