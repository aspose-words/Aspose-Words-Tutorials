...
| [Insertar objeto OLE en un documento de Word como icono](./insert-ole-object-as-icon/) Aprenda a insertar un objeto OLE como icono en documentos de Word con Aspose.Words para .NET. Siga la guía paso a paso para optimizar sus documentos. |
...
| [Crear control ActiveX en un documento de Word con C#](./how-to-create-activex-control-in-a-word-document-with-c/) | Aprenda a crear un control ActiveX en un documento de Word usando C# y Aspose.Words para .NET. |
