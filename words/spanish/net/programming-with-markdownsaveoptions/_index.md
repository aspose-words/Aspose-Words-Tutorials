...
| [Carpeta de imágenes personalizada – Convertir Word a Markdown con Aspose.Words](./custom-image-folder-convert-word-to-markdown-with-aspose-wor/) Aprenda a establecer una carpeta personalizada para imágenes al convertir documentos Word a Markdown usando Aspose.Words para .NET. |
...
### [Convertir docx a markdown con Aspose.Words – Guía completa](./convert-docx-to-markdown-with-aspose-words-complete-guide/) Aprenda a convertir archivos DOCX a Markdown usando Aspose.Words con una guía completa paso a paso.
