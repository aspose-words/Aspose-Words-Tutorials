...
### [Crear carpeta de recursos para convertir Word a Markdown](./create-assets-folder-for-convert-word-to-markdown/) Aprenda a crear una carpeta de activos para organizar imágenes y recursos al convertir documentos Word a Markdown con Aspose.Words.
### [Guardar Word como Markdown – Guía completa con Aspose.Words](./save-word-as-markdown-complete-guide-with-aspose-words/) Aprenda a guardar documentos Word como archivos Markdown paso a paso usando Aspose.Words para .NET.
