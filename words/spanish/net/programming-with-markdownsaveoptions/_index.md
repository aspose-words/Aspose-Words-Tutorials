...
### [Cómo guardar Markdown desde Word – Guía completa para extraer imágenes y convertir DOCX](./how-to-save-markdown-from-word-complete-guide-to-extract-ima/) Aprenda a guardar documentos Word como archivos Markdown, extrayendo imágenes y convirtiendo DOCX usando Aspose.Words para .NET.
### [Convertir DOCX a Markdown – Guía completa para exportar Word a Markdown](./convert-docx-to-markdown-complete-guide-to-export-word-to-ma/) Aprenda a convertir archivos DOCX a Markdown con una guía completa para exportar documentos Word usando Aspose.Words para .NET.
