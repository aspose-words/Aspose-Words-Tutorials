...
### [Ruta relativa de imagen markdown – Convertir Word a Markdown](./markdown-image-relative-path-convert-word-to-markdown/) Aprenda a usar rutas relativas para imágenes al convertir documentos Word a Markdown con Aspose.Words para .NET.
