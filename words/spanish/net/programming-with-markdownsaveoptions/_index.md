...
### [Guardar docx como markdown – Guía completa con ecuaciones LaTeX](./save-docx-as-markdown-complete-guide-with-latex-equations/) Aprenda a guardar documentos DOCX como Markdown conservando ecuaciones LaTeX usando Aspose.Words para .NET.
### [Carpeta de imágenes personalizada para exportar Markdown con imágenes – Guía completa](./custom-image-folder-for-export-markdown-with-images-complete/) Aprenda a configurar una carpeta personalizada para guardar imágenes al exportar documentos a Markdown con Aspose.Words para .NET.
