...
### [Guardar docx como markdown – Guía completa en C# con Aspose.Words](./save-docx-as-markdown-complete-c-guide-with-aspose-words/) Aprenda a guardar documentos DOCX como Markdown usando Aspose.Words para .NET.
### [Exportar Word a Markdown con sombras de forma y PDF/UA](./export-word-to-markdown-with-shape-shadows-and-pdf-ua/) Aprenda a exportar documentos Word a Markdown conservando sombras de formas y cumpliendo con PDF/UA usando Aspose.Words para .NET.
