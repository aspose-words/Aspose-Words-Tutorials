...
language: en
og_description: Create Word document Python tutorial walks you through adding a shadow
  to a shape, applying a shadow effect in Word using Aspose.Words.
og_title: Create Word Document Python – Add Shadow to Shape
schemas:
- author: Aspose
...
- aspose-words
- document automation
title: Create Word Document Python – Add Shadow to Shape Guide
url: /python/images-shapes/create-word-document-python-add-shadow-to-shape-guide/
---
...
# Create Word Document Python – Add Shadow to Shape Guide
...
*Alt text:* *Shadowed rectangle shape in a Word document – create word document python example.*
