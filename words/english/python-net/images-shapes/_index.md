...
### [Draw rectangle in PDF with Aspose.Words for Python](./draw-rectangle-in-pdf-with-aspose-words-for-python/)
Learn how to draw a rectangle shape in a PDF document using Aspose.Words for Python.
