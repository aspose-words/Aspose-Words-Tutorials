...
| [Create blank Word document and hide an ellipse shape in C#](./create-blank-word-document-and-hide-an-ellipse-shape-in-c/) | Learn how to create a blank Word document and hide an ellipse shape using Aspose.Words for .NET in C# with this step‑by‑step guide. |
...
| [How to create word document with shapes using Aspose.Words in C#](./how-to-create-word-document-with-shapes-using-aspose-words-i/) | Learn how to create a Word document with various shapes using Aspose.Words for .NET in C# with this step‑by‑step guide. |
