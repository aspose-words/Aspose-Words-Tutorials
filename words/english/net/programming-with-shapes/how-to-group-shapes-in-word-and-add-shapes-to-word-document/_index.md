...
language: C#
lastmod: 2026-08-07
og_description: How to group shapes in Word using Aspose.Words for .NET. This tutorial
  shows you how to add shapes to a Word document, group them, and save the file with
  clear C# code.
og_image_alt: Screenshot of a rectangle and ellipse grouped in a Word document created
  with Aspose.Words
og_title: How to group shapes in Word – quick C# guide
schemas:
- author: Aspose
...
- Word automation
- shapes
title: How to group shapes in Word and add shapes to Word document
url: /net/programming-with-shapes/how-to-group-shapes-in-word-and-add-shapes-to-word-document/
---
...
# How to group shapes in Word and add shapes to Word document
