---
title: Create a Formatted Table in Word with Aspose.Words for .NET
weight: 7700
limit: 
description: Learn to create a Word document with a formatted table using Aspose.Words for .NET with this step-by-step example.
