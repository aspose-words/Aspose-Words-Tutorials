...
{{< tutorial-card link="./add-section/" title="Add a New Section to Word Document" imgSrc="./add-section/images/thumb.png" >}}

{{< tutorial-card link="./append-section-content/" title="Append and Prepend Content in Word Documents" imgSrc="./append-section-content/images/thumb.png" >}}
