...
description: Save Word as PDF using Aspose.Words in C#. Learn how to convert docx
  to pdf, export shapes, and save document as pdf with clear step‑by‑step code.
draft: false
keywords:
- save word as pdf
- convert docx to pdf
...
- convert word pdf c#
language: en
og_description: Save Word as PDF quickly. This tutorial shows how to convert docx
  to pdf, export shapes, and save document as pdf using Aspose.Words C#.
og_title: Save Word as PDF in C# – Complete Conversion Guide
tags:
- Aspose.Words
- C#
- PDF conversion
title: Save Word as PDF in C# – Full Guide to Convert DOCX to PDF with Shape Export
url: /net/programming-with-pdfsaveoptions/save-word-as-pdf-in-c-full-guide-to-convert-docx-to-pdf-with/
---
...
# Save Word as PDF in C# – Complete Guide
...
- Aspose.Words for .NET (the free trial works for testing)  
- A DOCX file that contains at least one floating shape (image, text box, SmartArt, etc.)  
