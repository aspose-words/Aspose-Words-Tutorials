...
| Question | Answer |
|----------|--------|
| *Do I need a license for Aspose.Words?* | The library works in evaluation mode without a license, but for production use you need a commercial license. See the licensing information at {{< relref "net/apply-license/_index.md" >}}. |
