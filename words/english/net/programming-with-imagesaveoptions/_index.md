...
| [how to set dpi – Export Word to PNG Grid in C#](./how-to-set-dpi-export-word-to-png-grid-in-c/) | Learn how to export Word pages to a PNG grid with custom DPI settings using Aspose.Words for .NET in C#. |
