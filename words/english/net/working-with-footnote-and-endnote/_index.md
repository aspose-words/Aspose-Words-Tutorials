...
| [Change footnote separator in C# using Aspose.Words](./change-footnote-separator-in-c-using-aspose-words/) | Learn how to change the footnote separator in Word documents using Aspose.Words for .NET with C#. |
