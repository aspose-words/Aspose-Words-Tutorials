...
category: general
date: 2026-04-04
description: Learn how to use pdf save options in Java to convert docx to pdf and
  export shapes as inline tags. Step‑by‑step guide for saving docx as pdf.
draft: false
keywords:
- pdf save options
- convert docx to pdf
...
- convert word to pdf
language: en
og_description: Discover pdf save options in Java to convert docx to pdf and export
  shapes as inline tags. Complete guide for saving docx as pdf.
og_title: 'pdf save options: Convert DOCX to PDF with Shape Tags'
tags:
- Aspose.Words
- Java
- PDF generation
title: 'pdf save options: Convert DOCX to PDF with Shape Tags'
url: /java/document-conversion-and-export/pdf-save-options-convert-docx-to-pdf-with-shape-tags/
---
