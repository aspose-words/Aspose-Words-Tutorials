...
language: en
og_description: 'save as plain text tutorial: convert docx to txt, export word equations,
  and save word as txt using Aspose.Words.'
og_title: save as plain text – Export Word Equations in Java
schemas:
- author: Aspose
...
- Aspose.Words
- Document Conversion
title: save as plain text – Complete Guide to Export Word Equations
url: /java/document-conversion-and-export/save-as-plain-text-complete-guide-to-export-word-equations/
---
