...
url: /java/document-conversion-and-export/convert-docx-to-markdown-with-embedded-images-java-guide/
---
...
# convert docx to markdown with embedded images – Java guide
