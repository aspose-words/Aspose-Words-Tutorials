...
### Apakah yang `NodeType` properti di Aspose.Words?

Itu `NodeType` properti mengidentifikasi jenis node dalam suatu dokumen, seperti Dokumen, Bagian, Paragraf, Run, atau Tabel.

### Bagaimana cara saya memeriksa `NodeType` dari suatu simpul?
