...
Mengganti `"MyBookmark1"` dengan nama sebenarnya penanda buku Anda.
...
Ya, Aspose.Words mendukung berbagai format Word, dan metode ini berfungsi di semua format ini.
