...
| [Cara menyisipkan tag dan membuat bentuk grup dalam DOCX](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) | Pelajari cara menyisipkan tag dan membuat bentuk grup dalam file DOCX menggunakan Aspose.Words untuk .NET. |
| [Cara menyembunyikan bentuk di dokumen Word dengan kode C#](./how-to-hide-shape-in-a-word-document-with-c-code/) | Pelajari cara menyembunyikan bentuk dalam dokumen Word menggunakan Aspose.Words untuk .NET dengan contoh kode C#. |
