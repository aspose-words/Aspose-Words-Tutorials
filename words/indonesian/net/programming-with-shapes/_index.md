...
| [Cara mengelompokkan bentuk di Word menggunakan DocumentBuilder – panduan langkah demi langkah](./how-to-group-shapes-in-word-using-documentbuilder-step-by-st/) | Pelajari cara mengelompokkan bentuk di Word menggunakan DocumentBuilder dengan panduan langkah demi langkah. |
...
| [Buat Bentuk Persegi Panjang dan Grup Bentuk di Word menggunakan C#](./create-rectangle-shape-and-group-shapes-in-word-using-c/) | Pelajari cara membuat bentuk persegi panjang dan mengelompokkan bentuk di dokumen Word menggunakan Aspose.Words untuk .NET dengan C#. |
