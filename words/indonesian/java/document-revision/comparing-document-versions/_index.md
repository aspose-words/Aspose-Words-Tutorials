...
### Apa tujuan dari `compare` metode di Aspose.Words?  
Itu `compare` metode mengidentifikasi perbedaan antara dua dokumen Word dan menandainya sebagai revisi.

### Bisakah saya membandingkan dokumen dalam format selain `.doc` atau `.docx`....  
Ya! Aspose.Words mendukung berbagai format, termasuk `.rtf`Bahasa Indonesia: `.odt`, Dan `.txt`.
