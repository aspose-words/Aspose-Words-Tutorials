...
## Βήμα 2: Δημιουργία νέου εγγράφου και εργαλείου δόμησης
...
## Βήμα 3: Εισαγωγή ορθογωνίου σχήματος και ορισμός του χρώματος γεμίσματός του
...
## Βήμα 4: Ρύθμιση της εμφάνισης σκιάς – Εφαρμογή σκιάς στο σχήμα
...
## Συνήθεις ερωτήσεις και πεζά/κεφαλαία
...
### Πώς μπορώ να προσθέσω το σχήμα σε μια συγκεκριμένη παράγραφο;
...
### Μπορώ να εφαρμόσω γέμισμα με διαβάθμιση αντί για ένα ενιαίο χρώμα;
...
### Τι γίνεται με τη συμβατότητα με παλαιότερες εκδόσεις του Word;
