...
### [在转换为 Markdown 时保存 Word 图像 – 完整 C# 指南](./save-word-images-while-converting-to-markdown-complete-c-gui/)

使用 Aspose.Words for .NET 将 Word 文档转换为 Markdown，同时提取并保存嵌入的图像，提供完整的 C# 示例和步骤指南。
