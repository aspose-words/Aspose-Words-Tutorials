...
| [在 DOCX 中插入标签并创建组形状](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) 通过本分步指南学习如何在 DOCX 文档中插入标签并创建组形状。|
...
| [在 Word 文档中使用 C# 隐藏形状](./how-to-hide-shape-in-a-word-document-with-c-code/) 通过本分步指南学习如何使用 Aspose.Words for .NET 在 Word 文档中隐藏形状。|
