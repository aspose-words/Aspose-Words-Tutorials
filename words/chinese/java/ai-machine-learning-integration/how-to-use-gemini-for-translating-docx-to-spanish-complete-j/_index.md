...
category: general
date: 2026-06-24
description: 如何在 Java 中使用 Gemini 将 DOCX 文件翻译成西班牙语。学习配置 AI 翻译并使用一步步代码将英文 DOCX 翻译成西班牙语。
draft: false
keywords:
- how to use gemini
...
language: zh
og_description: 如何使用 Gemini 将英文 DOCX 翻译成西班牙语。本指南将带您完成 AI 翻译的配置，并展示完整的 Java 代码。
og_title: 如何使用 Gemini – Java 将 DOCX 翻译成西班牙语
schemas:
- author: Aspose
...
- gemini
- ai
title: 如何使用 Gemini 将 DOCX 翻译成西班牙语 – 完整 Java 指南
url: /zh/java/ai-machine-learning-integration/how-to-use-gemini-for-translating-docx-to-spanish-complete-j/
---
...
# 如何使用 Gemini 将 DOCX 翻译成西班牙语 – 完整 Java 指南
...
![Diagram showing how to use gemini for document translation](https://example.com/diagram.png){: .center-image alt="如何使用 Gemini 的示意图，展示翻译流程"}
