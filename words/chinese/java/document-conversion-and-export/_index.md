...
### [在 Java 中将 Word 保存为 Markdown – 将表格导出为 HTML](./save-word-as-markdown-export-tables-to-html-in-java/)
演示如何使用 Aspose.Words for Java 将 Word 文档保存为 Markdown，并将其中的表格导出为 HTML 格式。
