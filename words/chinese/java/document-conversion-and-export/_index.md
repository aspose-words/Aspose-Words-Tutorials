...
### [在 Aspose.Words for Java 中将 Word 保存为带 HTML 表格的 Markdown](./how-to-save-word-as-markdown-with-html-tables-in-java/)

演示如何使用 Aspose.Words for Java 将 Word 文档转换为 Markdown，并保留其中的 HTML 表格。
