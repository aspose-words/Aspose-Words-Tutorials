...
category: general
date: 2026-08-07
description: Leer hoe je een ActiveX-besturingselement toevoegt aan een Word‑document
  met C#. Inclusief het koppelen van een macro aan een knop en het toevoegen van klikbare
  knoppen in Word‑voorbeelden.
draft: false
images:
...
language: nl
lastmod: 2026-08-07
og_description: hoe een ActiveX-besturingselement toe te voegen in een Word‑document
  met Aspose.Words. Volg deze gids om een knop in te voegen, een macro aan de knop
  te koppelen en een klikbare knop aan Word toe te voegen.
og_image_alt: Screenshot showing a Word document with an ActiveX command button inserted
  via Aspose.Words
og_title: hoe ActiveX-besturingselement toe te voegen in Word – volledige C#-tutorial
schemas:
- author: Aspose
...
- C#
- Word automation
title: Hoe een ActiveX‑besturingselement toe te voegen in Word met Aspose.Words –
  stapsgewijze handleiding
url: /nl/net/working-with-oleobjects-and-activex/how-to-add-activex-control-in-word-with-aspose-words-step-by/
---
...
# hoe voeg je een activex‑besturingselement toe in Word met Aspose.Words
...
> **Opmerking:** The coordinates (left, top) are measured in points (1 pt ≈ 1/72 in). Adjust them to position the button where you need it on the page.
...
### Veelvoorkomende valkuilen bij het koppelen van een macro
...
**Verwacht resultaat:** Opening `SubmitForm.docm` in Microsoft Word displays a blue‑bordered button labeled *Submit Form*. Clicking the button triggers the VBA macro `SubmitMacro` (provided you added the macro to the document). The button can be moved, resized, or styled further using the same `Forms2OleControl` object.
...
| Vraag | Antwoord |
|-------|----------|
| *Kan ik meer dan één ActiveX‑knop toevoegen?* | Ja. Call `InsertForms2OleControl` multiple times with different coordinates. Use distinct `OnAction` and `AltText` values to differentiate them. |
| *Is het ActiveX‑besturingselement zichtbaar in Word Online?* | Nee. |
...
- [Aspose.Words Shape Shadow Tutorial – Een schaduw toevoegen aan Word‑vorm in C#](/words/english/net/programming-with-shapes/aspose-words-shape-shadow-tutorial-add-a-shadow-to-word-shap/)
- [Een nieuw gedeelte toevoegen aan Word‑document \| Aspose.Words voor .NET](/words/english/net/document-sections/add-section/)
