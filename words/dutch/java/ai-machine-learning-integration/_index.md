...
### [Samenvatten van Word-document in Java met zelf‑gehoste LLM – volledige gids](./summarize-word-document-in-java-with-self-hosted-llm-full-gu/)
Leer hoe je met een zelf‑gehoste LLM een Word‑document kunt samenvatten in Java, van API‑integratie tot invoegen van de samenvatting.
