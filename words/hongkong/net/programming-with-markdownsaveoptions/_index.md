...
| [自訂圖像資料夾 – 使用 Aspose.Words 轉換 Word 為 Markdown](./custom-image-folder-convert-word-to-markdown-with-aspose-wor/) |示範如何在使用 Aspose.Words 轉換 Word 為 Markdown 時，設定自訂圖像資料夾以正確儲存圖片。 |
