...
| [使用 Aspose.Words 在 C# 中建立帶形狀的 Word 文件](./how-to-create-word-document-with-shapes-using-aspose-words-i/) |了解如何使用 Aspose.Words for .NET 在 C# 中建立包含形狀的 Word 文件。 |
| [在 C# 中建立空白 Word 文件並隱藏橢圓形狀](./create-blank-word-document-and-hide-an-ellipse-shape-in-c/) |透過本教學學習如何使用 Aspose.Words for .NET 在 C# 中建立空白 Word 文件，並將橢圓形狀設為隱藏。 |
