...
| [如何在 DOCX 中插入標籤並建立群組形狀](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) |了解如何使用 Aspose.Words for .NET 在 DOCX 文件中插入標籤並建立群組形狀。 |
...
| [如何在 Word 文件中使用 C# 程式碼隱藏形狀](./how-to-hide-shape-in-a-word-document-with-c-code/) |了解如何使用 Aspose.Words for .NET 於 C# 中隱藏 Word 文件中的形狀。 |
