...
category: general
date: 2026-05-29
description: 學習如何呼叫 CheckGrammar 並使用 Aspose.Words 為 Word 文件套用 AI 文法檢查，並附有逐步示例。
draft: false
keywords:
- how to call checkgrammar
- apply ai grammar check
language: zh-hant
og_description: 如何呼叫 CheckGrammar 並使用 Aspose.Words 為您的 Word 檔案套用 AI 文法檢查。完整程式碼範例與說明。
og_title: 如何在 C# 中呼叫 CheckGrammar – 完整指南
schemas:
- author: Aspose
...
- C#
- AI
title: 如何在 C# 中呼叫 CheckGrammar – 完整指南
url: /zh-hant/net/ai-powered-document-processing/how-to-call-checkgrammar-in-c-complete-guide/
---
