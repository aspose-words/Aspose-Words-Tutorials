...
# 將文件儲存為 Txt – 在 C# 中將 Word 數學公式匯出為 LaTeX
...
## 步驟 3：替代方案 – 不使用 TxtSaveOptions 將 docx 轉換為 LaTeX
