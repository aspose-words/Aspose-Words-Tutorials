...
### [在 Java 中的 PDF 可及性標記 – 產生可存取的 PDF](./pdf-accessibility-tagging-in-java-generate-accessible-pdfs/)
了解如何在 Java 中使用 Aspose.Words 為 PDF 添加可及性標記，生成符合 WCAG 標準的可存取 PDF 文件。
