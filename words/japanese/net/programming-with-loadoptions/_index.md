...
| [復元モードを有効にする – 破損した Word 文書を復元](./enable-recovery-mode-recover-corrupted-word-document/) Aspose.Words for .NET の LoadOptions を使用して、復元モードを有効にし、破損した Word 文書を安全に復元する手順を解説します。 |
