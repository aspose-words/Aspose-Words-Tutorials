...
| [كيفية إدراج علامة وإنشاء شكل مجموعة في ملف DOCX](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) |  |
| [كيفية إخفاء الشكل في مستند Word باستخدام كود C#](./how-to-hide-shape-in-a-word-document-with-c-code/) | تعلم كيفية إخفاء الأشكال في مستندات Word باستخدام C#. |
