...
| [كيفية إنشاء مستند Word مع أشكال باستخدام Aspose.Words في C#](./how-to-create-word-document-with-shapes-using-aspose-words-i/) | تعلم كيفية إنشاء مستند Word يحتوي على أشكال باستخدام Aspose.Words وC# خطوة بخطوة. |
| [إنشاء مستند Word فارغ وإخفاء شكل إهليلجي في C#](./create-blank-word-document-and-hide-an-ellipse-shape-in-c/) | تعلم كيفية إنشاء مستند Word فارغ وإخفاء شكل إهليلجي باستخدام Aspose.Words وC#. |
