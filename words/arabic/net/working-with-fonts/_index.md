...
| [التقاط تحذيرات الخط – اكتشاف وإدراج الخطوط المفقودة](./capture-font-warnings-detect-list-missing-fonts/) |تعرف على كيفية التقاط تحذيرات الخطوط المفقودة وإدراجها في تقرير باستخدام Aspose.Words لـ .NET. |
