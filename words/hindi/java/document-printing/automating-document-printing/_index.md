...
किसी दस्तावेज़ को प्रिंट करने से पहले, आपको उसे Aspose.Words for Java का उपयोग करके खोलना होगा। यह आपके दस्तावेज़ को प्रिंट करने के लिए तैयार करने का पहला चरण है।
...
- `if (!pj.printDialog(attributes)) { return; }` उपयोगकर्ता को प्रिंट डायलॉग प्रदर्शित करता है। यदि उपयोगकर्ता प्रिंट डायलॉग को रद्द कर देता है, तो विधि जल्दी वापस आ जाती है।
...
प्रिंट करने से पहले, आप उपयोगकर्ता को प्रिंट पूर्वावलोकन दिखाना चाह सकते हैं। यह चरण वैकल्पिक है, लेकिन यह जाँचने के लिए उपयोगी हो सकता है कि दस्तावेज़ प्रिंट होने पर कैसा दिखेगा।
