...
1. Aspose.Words for Java: लाइब्रेरी यहाँ से डाउनलोड करें [यहाँ](https://releases.aspose.com/words/java/).  
...
2. पृष्ठ निकालें:  
   - The `extractPages` विधि वर्तमान पृष्ठ को अलग करती है (`page`को एक नए रूप में परिवर्तित करना `Document` वस्तु।  
   - दूसरा पैरामीटर `1` निकाले जाने वाले पृष्ठों की संख्या निर्दिष्ट करता है.  

3. प्रत्येक पृष्ठ सहेजें:  
   - The `save` विधि निकाले गए पृष्ठ को एक नई फ़ाइल में लिखती है।  
...
The `extractPages` विधि छवियों, तालिकाओं और स्वरूपण सहित सभी सामग्री को संरक्षित करती है।  

### क्या मैं पीडीएफ जैसी अन्य फ़ाइल प्रकारों को विभाजित कर सकता हूँ?  
नहीं, यह ट्यूटोरियल वर्ड दस्तावेज़ों पर केंद्रित है। PDF विभाजन के लिए, Aspose.PDF का उपयोग करें।  
