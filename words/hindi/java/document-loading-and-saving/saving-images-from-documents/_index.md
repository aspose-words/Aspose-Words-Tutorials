...
# Java के लिए Aspose.Words में दस्तावेज़ों से छवियाँ सहेजना
...
छवि सहेजने को अनुकूलित करने के लिए कॉलबैक का उपयोग करने के लिए, सेट करें `PageSavमेंgCallback` in `ImageSaveOptions`एक ऐसा वर्ग बनाएं जो कार्यान्वित करता है `IPageSavingCallback` इंटरफ़ेस और ओवरराइड `pageSaving` तरीका।
