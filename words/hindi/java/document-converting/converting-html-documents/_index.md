...
The `save` विधि को कॉल किया जाता है `Document` फ़ाइल को सहेजने के लिए ऑब्जेक्ट `.docx` प्रारूप। प्रदान किया गया तर्क वह फ़ाइल पथ है जहाँ Word दस्तावेज़ सहेजा जाएगा। यह रूपांतरण प्रक्रिया का अंतिम चरण है।
...
हां, आप HTML सामग्री को Word दस्तावेज़ के रूप में सहेजने से पहले उसमें बदलाव कर सकते हैं। आप Aspose.Words के विस्तृत API का उपयोग करके इसे संशोधित कर सकते हैं। `Document` HTML फ़ाइल लोड करने के बाद ऑब्जेक्ट.

### 2. क्या Aspose.Words for Java अन्य फ़ाइल स्वरूपों का समर्थन करता है?

बिल्कुल! Aspose.Words for Java PDF, HTML, EPUB, आदि सहित विभिन्न फ़ाइल स्वरूपों का समर्थन करता है, जो इसे दस्तावेज़ रूपांतरण और हेरफेर के लिए एक बहुमुखी उपकरण बनाता है।
