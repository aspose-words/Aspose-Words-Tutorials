...
- The `save` विधि परिवर्तनों को एक नई फ़ाइल में लिखती है, तथा संशोधनों को सुरक्षित रखती है।
...
### इसका उद्देश्य क्या है? `compare` Aspose.Words में विधि क्या है?  
The `compare` विधि दो वर्ड दस्तावेज़ों के बीच अंतर की पहचान करती है और उन्हें संशोधन के रूप में चिह्नित करती है।

### क्या मैं दस्तावेज़ों की तुलना अन्य प्रारूपों में कर सकता हूँ? `.doc` या `.docx`?  
