...
इससे "Aspose Website" पाठ के साथ एक क्लिक करने योग्य लिंक सम्मिलित हो जाएगा जो Aspose होमपेज पर पुनः निर्देशित करेगा।
...
हां, आप हाइपरलिंक को अलग-अलग तरीके से सेट करके स्टाइल कर सकते हैं `Font` प्रत्येक हाइपरलिंक डालने से पहले गुण देखें।
