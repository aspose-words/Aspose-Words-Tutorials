---
"description": "जानें कि Aspose.Words for .NET में डॉक्यूमेंट बिल्डर का उपयोग किए बिना ASK फ़ील्ड कैसे डालें। अपने Word दस्तावेज़ों को गतिशील रूप से बढ़ाने के लिए इस गाइड का पालन करें।"
...
### इसका उद्देश्य क्या है? `PromptOnceOnMailMerge` संपत्ति?
The `PromptOnceOnMailMerge` गुण यह निर्धारित करता है कि मेल मर्ज ऑपरेशन के दौरान ASK प्रॉम्प्ट केवल एक बार दिखाई देता है या हर बार।
