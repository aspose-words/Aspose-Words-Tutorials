...
The `UpdateFields` विधि दस्तावेज़ में सभी फ़ील्ड के माध्यम से पुनरावृत्त होती है और उन्हें नवीनतम डेटा के साथ अपडेट करती है। यदि आपके फ़ील्ड दिनांक या गणना जैसी गतिशील सामग्री पर निर्भर करते हैं तो यह चरण महत्वपूर्ण है।
...
The `DisplayResult` की संपत्ति `Field` क्लास फ़ील्ड का स्वरूपित मान लौटाता है। `foreach` लूप दस्तावेज़ के सभी फ़ील्डों से गुजरता है और उनके परिणाम प्रिंट करता है।
...
नहीं, फोन कर रहा हूं `UpdateFields` दस्तावेज़ को स्वचालित रूप से सहेजा नहीं जाता है। `Save` किसी भी परिवर्तन को सहेजने की विधि.
...
The `DisplayResult` प्रॉपर्टी फ़ॉर्मेटेड आउटपुट प्रदान करती है। यदि आपको किसी भिन्न फ़ॉर्मेट की आवश्यकता है, तो अपनी आवश्यकताओं के आधार पर अतिरिक्त प्रोसेसिंग पर विचार करें।
