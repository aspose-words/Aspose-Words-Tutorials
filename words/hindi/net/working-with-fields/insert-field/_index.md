...
अपना Visual Studio चालू करें और एक नया C# प्रोजेक्ट बनाएँ। आप ऐसा File > New > Project पर जाकर और Console App (.NET Framework) चुनकर कर सकते हैं। अपने प्रोजेक्ट को एक नाम दें और Create पर क्लिक करें।
...
हां, आप अपने डेटा के माध्यम से लूपिंग करके और प्रोग्रामेटिक रूप से फ़ील्ड सम्मिलित करने के लिए डॉक्यूमेंटबिल्डर का उपयोग करके बल्क में फ़ील्ड सम्मिलित करने को स्वचालित कर सकते हैं।
