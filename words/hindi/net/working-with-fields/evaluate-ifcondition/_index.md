...
यहाँ, `builder.InsertField` वर्तमान कर्सर स्थिति पर फ़ील्ड डालने के लिए उपयोग किया जाता है। फ़ील्ड प्रकार इस प्रकार निर्दिष्ट किया जाता है `"IF 1 = 1"`, जो एक सरल शर्त है जहाँ 1 बराबर 1 होता है। यह हमेशा सत्य मानेगा। `null` पैरामीटर यह दर्शाता है कि फ़ील्ड के लिए कोई अतिरिक्त स्वरूपण आवश्यक नहीं है।
...
The `EvaluateCondition` विधि एक लौटाती है `FieldIfComparisonResult` enum जो स्थिति मूल्यांकन के परिणाम को दर्शाता है। इस enum के मान इस प्रकार हो सकते हैं `True`, `False`, या `Unknown`.
...
### क्या करता है `EvaluateCondition` विधि क्या है?
The `EvaluateCondition` विधि IF फ़ील्ड में निर्दिष्ट स्थिति का मूल्यांकन करती है और परिणाम लौटाती है, जो यह इंगित करती है कि स्थिति सत्य है या असत्य।
