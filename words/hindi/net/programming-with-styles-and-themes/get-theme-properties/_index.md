...
The `MajorFonts` प्रॉपर्टी प्रमुख फ़ॉन्ट सेटिंग तक पहुँच प्रदान करती है। इस उदाहरण में, हम विशेष रूप से थीम में उपयोग किए गए लैटिन फ़ॉन्ट को पुनः प्राप्त कर रहे हैं। आप ईस्ट एशियन या कॉम्प्लेक्स स्क्रिप्ट फ़ॉन्ट जैसे अन्य प्रमुख फ़ॉन्ट प्राप्त करने के लिए समान कोड का उपयोग कर सकते हैं।
...
The `Colors` की संपत्ति `Theme` क्लास आपको थीम में परिभाषित विभिन्न रंग लहजे को पुनः प्राप्त करने की सुविधा देता है, जिससे आप अपने दस्तावेज़ों में सुसंगत रंग योजनाओं को प्रबंधित और लागू कर सकते हैं।
...
एक नई थीम लागू करने के लिए, आपको अपने ब्राउज़र पर थीम गुण सेट करने होंगे। `Document` ऑब्जेक्ट की जाँच करें। [Aspose.Words दस्तावेज़ीकरण](https://reference.aspose.com/words/net/) थीम लागू करने के विवरण के लिए.
