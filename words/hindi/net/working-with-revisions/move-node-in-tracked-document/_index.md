...
हां, आप कई नोड्स को उन पर पुनरावृत्ति करके और इस तरह के तरीकों का उपयोग करके स्थानांतरित कर सकते हैं `InsertBefयाe` or `InsertAfter` उन्हें वांछित स्थान पर रखने के लिए।
