...
इससे संशोधित दस्तावेज़ को नए नाम से सहेजा जाएगा, जिससे यह सुनिश्चित होगा कि आप मूल फ़ाइल को अधिलेखित नहीं करेंगे। अब आप इस नई फ़ाइल को खोलकर देख सकते हैं कि सभी व्याकरणिक और वर्तनी संबंधी त्रुटियाँ हाइलाइट की गई हैं।
...
Aspose.Words for .NET एक शक्तिशाली लाइब्रेरी है जो डेवलपर्स को प्रोग्रामेटिक रूप से Word दस्तावेज़ बनाने, संशोधित करने और परिवर्तित करने में सक्षम बनाती है।
