...
अब चलिए Document क्लास की Compare विधि का उपयोग करके दस्तावेज़ों की तुलना करते हैं। परिवर्तन दस्तावेज़ A में सहेजे जाएँगे।

```csharp
builderA.Document.Compare(builderB.Document, "author", DateTime.Now, compareOptions);
```

The `Compare` विधि दस्तावेज़ A की तुलना दस्तावेज़ B से करती है और दस्तावेज़ A में किए गए परिवर्तनों को सहेजती है। आप संदर्भ के लिए लेखक का नाम और तुलना की तारीख निर्दिष्ट कर सकते हैं।
...
5. उपयोग `Compare` एक दस्तावेज़ पर विधि, दूसरे दस्तावेज़ को पारित करना और `CompareOptions` ऑब्जेक्ट को पैरामीटर के रूप में सेट करें। यह विधि निर्दिष्ट ग्रैन्युलैरिटी के आधार पर दस्तावेज़ों की तुलना करेगी और पहले दस्तावेज़ में परिवर्तनों को सहेजेगी।
