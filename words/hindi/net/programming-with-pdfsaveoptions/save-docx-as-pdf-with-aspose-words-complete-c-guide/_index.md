...
A: Yes. Aspose.Words दोनों लेगेसी `.doc` और मॉडर्न `.docx` को सपोर्ट करता है। बस `sourcePath` को उचित फ़ाइल की ओर पॉइंट करें।

**Q: What if I need to hide the floating shapes altogether?**  
A: `ExportFloatingShapesAsInlineTag = false` (डिफ़ॉल्ट) सेट करें और वैकल्पिक रूप से डॉक्यूमेंट से उन्हें हटाएँ इससे पहले कि आप सेव करें।
...
A: Wrap the conversion code in a `foreach (var file in Directory.GetFiles(folder, "*.docx"))` लूप। समान `PdfSaveOptions` इंस्टेंस को री‑यूज़ करने से परफ़ॉर्मेंस बेहतर होता है।
