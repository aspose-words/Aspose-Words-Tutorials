...
- The `SetPassword` विधि को कॉल किया जाता है `WriteProtection` दस्तावेज़ की संपत्ति.
...
- The `ReadOnlyRecommended` संपत्ति पर सेट है `true`.
...
- The `Protect` विधि को दस्तावेज़ पर बुलाया जाता है `ProtectionType.ReadOnly` तर्क के रूप में.
...
- The `Save` दस्तावेज़ पर विधि को कॉल किया जाता है, जो फ़ाइल का पथ और नाम निर्दिष्ट करता है।
