...
The `Styles` की संपत्ति `Document` क्लास हमें दस्तावेज़ में उपलब्ध सभी शैलियों तक पहुँच प्रदान करता है। हम इसका उपयोग करते हैं `StyleIdentifier.Quote` उद्धरण शैली का चयन करने के लिए.
...
हां, Aspose.Words जावा, C++, और अन्य प्लेटफॉर्म के लिए उपलब्ध है। उनकी जाँच करें [प्रलेखन](https://reference.aspose.com/words/net/) अधिक जानकारी के लिए.
