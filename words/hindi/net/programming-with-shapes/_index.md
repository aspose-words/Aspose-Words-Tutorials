...
| [Aspose.Words के साथ Word में आयत आकार बनाएं – चरण‑दर‑चरण गाइड](./create-rectangle-shape-in-word-with-aspose-words-step-by-ste/) | Aspose.Words का उपयोग करके Word दस्तावेज़ में आयत आकार बनाने और अनुकूलित करने के चरण‑दर‑स्टेप निर्देश। |
| [Word आकृति पर शैडो सेट करें – C# ट्यूटोरियल](./how-to-set-shadow-on-a-word-shape-c-tutorial/) | .NET के लिए Aspose.Words का उपयोग करके Word आकृति में शैडो कैसे सेट करें, इस चरण‑दर‑स्टेप गाइड में सीखें। |
