...
### क्या है? `DocumentDirection` संपत्ति का उपयोग किस लिए किया जाता है?

The `DocumentDirection` संपत्ति में `TxtLoadOptions` दस्तावेज़ के लिए पाठ की दिशा निर्धारित करता है। इसे इस प्रकार सेट किया जा सकता है `DocumentDirection.Auto`, `DocumentDirection.LeftToRight`, या `DocumentDirection.RightToLeft`.

### क्या मैं संपूर्ण दस्तावेज़ के बजाय विशिष्ट पैराग्राफ़ के लिए पाठ की दिशा निर्धारित कर सकता हूँ?
