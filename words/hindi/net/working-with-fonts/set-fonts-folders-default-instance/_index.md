...
फ़ॉन्ट फ़ोल्डर सेट होने के बाद, अगला चरण आपके वर्ड दस्तावेज़ को Aspose.Words में लोड करना है। यह उपयोग करके किया जाता है `Document` कक्षा।
...
हां, आप इसका उपयोग करके एकाधिक फ़ॉन्ट फ़ोल्डर्स सेट कर सकते हैं `SetFontsFolders` विधि जो फ़ोल्डर पथों की एक सरणी स्वीकार करती है।
