...
`FontWarningCollector` के अंदर एक `List<string>` में संदेशों को स्टोर करें और उसे प्रॉपर्टी के ज़रिए एक्सपोज़ करें। इस तरह आप कई दस्तावेज़ प्रोसेस करने के बाद सूची को लॉग फ़ाइल में लिख सकते हैं।

### Does this work with encrypted or password‑protected files?

हाँ, लेकिन आपको `LoadOptions.Password` के माध्यम से पासवर्ड भी देना होगा। एक बार दस्तावेज़ डिक्रिप्ट हो जाने पर चेतावनी कॉलबैक समान रूप से काम करता है।
...
ओवरहेड न्यूनतम है—प्रत्येक चेतावनी पर एक मेथड कॉल। हजारों दस्तावेज़ की बैच में इसका प्रभाव लोडिंग के I/O लागत की तुलना में नगण्य है।
