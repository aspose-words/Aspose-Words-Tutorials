...
इससे पहले कि हम ट्यूटोरियल में आगे बढ़ें, आइए सुनिश्चित करें कि आपके पास इसे सुचारू रूप से चलाने के लिए आवश्यक सभी चीजें मौजूद हैं।
...
आपके पास C# कोड चलाने के लिए एक विकास वातावरण होना चाहिए, जैसे:
...
सबसे पहले हमें टेबल वाला वर्ड डॉक्यूमेंट लोड करना होगा। इसके लिए हम इसका इस्तेमाल करेंगे `Document` Aspose.Words से क्लास। यह क्लास आपको प्रोग्रामेटिक रूप से Word फ़ाइलों को खोलने और उनमें हेरफेर करने की अनुमति देता है।
...
अब, हमें टेबल में प्रत्येक सेल के माध्यम से लूप करना होगा। चूँकि एक टेबल में कई पंक्तियाँ होती हैं और प्रत्येक पंक्ति में कई सेल होते हैं, इसलिए हम प्रत्येक सेल के माध्यम से पुनरावृत्ति करेंगे और सुनिश्चित करेंगे कि यह पृष्ठों में विभाजित न हो।
...
तालिका को पृष्ठों में विभाजित होने से रोकने के लिए, हमें सेट करने की आवश्यकता है `KeepWithNext` तालिका के भीतर प्रत्येक पैराग्राफ के लिए संपत्ति। यह संपत्ति सुनिश्चित करती है कि पैराग्राफ अगले पैराग्राफ के साथ बना रहे, जिससे उनके बीच पेज ब्रेक को प्रभावी ढंग से रोका जा सके।
