...
The `NodeType` प्रॉपर्टी Aspose.Words में एक मूलभूत विशेषता है। यह आपको उस नोड के प्रकार की पहचान करने की अनुमति देता है जिसके साथ आप काम कर रहे हैं। इस प्रॉपर्टी तक पहुँचने के लिए, बस निम्नलिखित कोड का उपयोग करें:
...
### क्या है? `NodeType` Aspose.Words में संपत्ति?

The `NodeType` गुण दस्तावेज़ के भीतर नोड के प्रकार की पहचान करता है, जैसे दस्तावेज़, अनुभाग, पैराग्राफ, रन या तालिका।

### मैं इसकी जांच कैसे करूँ? `NodeType` एक नोड का?
