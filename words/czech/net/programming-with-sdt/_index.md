...
| Název | Popis |
| --- | --- |
| [Ovládací prvek obsahu typu zaškrtávacího políčka](./check-box-type-content-control/) | Naučte se, jak přidat ovládací prvek obsahu typu zaškrtávacího políčka do dokumentů Word pomocí Aspose.Words pro .NET v tomto podrobném návodu krok za krokem. |
...
| [Jak vložit ovládací prvek obsahu do dokumentu Word pomocí C#](./how-to-insert-content-control-in-a-word-document-with-c/) | Naučte se, jak pomocí C# vložit ovládací prvek obsahu do dokumentu Word pomocí Aspose.Words pro .NET. |
