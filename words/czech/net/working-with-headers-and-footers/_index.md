...
{{< tutorial-card link="./add-page-numbers/" title="Přidejte čísla stránek do zápatí Word dokumentu pomocí Aspose.Words pro .NET" imgSrc="./add-page-numbers/images/thumb.png" >}}
