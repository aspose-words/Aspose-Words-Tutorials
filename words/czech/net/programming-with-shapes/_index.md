...
| [Jak vytvořit dokument Word s tvary pomocí Aspose.Words v C#](./how-to-create-word-document-with-shapes-using-aspose-words-i/) | Naučte se, jak pomocí Aspose.Words v C# vytvořit dokument Word obsahující různé tvary. |
| [Vytvořit prázdný dokument Word a skrýt eliptický tvar v C#](./create-blank-word-document-and-hide-an-ellipse-shape-in-c/) | Naučte se, jak vytvořit prázdný dokument Word a skrýt eliptický tvar pomocí Aspose.Words pro .NET v C#. |
