...
Bây giờ, chúng ta hãy chia nhỏ quy trình thành các bước đơn giản. Mỗi bước sẽ hướng dẫn bạn quy trình cập nhật thuộc tính thời gian đã lưu gần đây nhất trong tài liệu Word của bạn.

## Bước 1: Thiết lập thư mục tài liệu của bạn

Đầu tiên, bạn cần chỉ định đường dẫn đến thư mục tài liệu của mình. Đây là nơi lưu trữ tài liệu hiện tại của bạn và nơi tài liệu được cập nhật sẽ được lưu.
