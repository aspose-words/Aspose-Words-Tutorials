...
Sau khi nhập các không gian tên này, chúng ta đã sẵn sàng bắt đầu thiết lập các thư mục phông chữ tùy chỉnh.
...
Bạn có thể có được một [giấy phép tạm thời](https://purchase.aspose.com/temporary-license/) từ trang web Aspose để dùng thử đầy đủ tính năng của Aspose.Words.
