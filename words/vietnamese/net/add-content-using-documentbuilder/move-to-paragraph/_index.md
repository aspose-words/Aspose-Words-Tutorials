...
Trước tiên, chúng ta cần nhập các không gian tên cần thiết. Điều này giống như việc thiết lập bối cảnh trước buổi biểu diễn. Mở dự án của bạn trong Visual Studio và đảm bảo bạn có các không gian tên này ở đầu tệp của mình:
...
Hãy chắc chắn thay thế `"C:\\path\\to\\your\\Paragraphs.docx"` bằng đường dẫn thực tế đến tài liệu Word của bạn.
