...
Để bắt đầu, bạn cần nhập các không gian tên cần thiết vào dự án .NET của mình. Sau đây là đoạn mã cần đưa vào đầu tệp C# của bạn:
...
Hãy nghĩ về bước này như việc xác định vị trí bảng mà bạn muốn làm việc trong một tài liệu vật lý. Bạn cần biết chính xác vị trí của bảng để thực hiện bất kỳ thay đổi nào.
...
Hãy tưởng tượng treo một bức tranh trên tường. Bạn muốn đảm bảo bức tranh được căn giữa theo chiều dọc để có tính thẩm mỹ. Bước này sẽ đạt được điều đó.
...
### Làm thế nào để căn chỉnh bảng về bên phải tài liệu?
