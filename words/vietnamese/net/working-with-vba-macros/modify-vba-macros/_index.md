...
# Sửa đổi Macro VBA của một tài liệu Word
...
Thay thế `"YOUR DOCUMENT DIRECTORY"` với đường dẫn thực tế nơi lưu trữ tài liệu Word của bạn. Thư mục này sẽ là không gian làm việc của chúng tôi cho hướng dẫn.
...
Nếu bạn háo hức khám phá thêm, [Tài liệu API](https://reference.aspose.com/words/net/) là một nguồn tài nguyên tuyệt vời. Và nếu bạn gặp phải một trở ngại, [diễn đàn hỗ trợ](https://forum.aspose.com/c/words/8) luôn ở đó để giúp đỡ bạn.
