...
Bây giờ đến phần thú vị – phát hiện các hình dạng SmartArt trong tài liệu. Chúng ta sẽ đếm số lượng hình dạng có chứa SmartArt.
...
Sau khi viết xong mã, hãy chạy mã đó trong Visual Studio. Bảng điều khiển sẽ hiển thị số lượng hình dạng SmartArt được tìm thấy trong tài liệu.
