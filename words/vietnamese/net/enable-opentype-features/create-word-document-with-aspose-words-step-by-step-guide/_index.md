...
- Tùy chọn: một font có trọng lượng biến đổi như **Roboto Flex** đã được cài đặt trên máy (ví dụ sử dụng font này)

> **Pro tip:** Nếu bạn chưa có giấy phép, có thể yêu cầu khóa đánh giá tạm thời từ trang web của Aspose—chỉ cần đặt nó vào `App.config` của dự án hoặc thiết lập bằng code.
