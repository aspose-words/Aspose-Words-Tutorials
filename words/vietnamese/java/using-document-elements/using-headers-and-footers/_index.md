...
# Sử dụng Header và Footer trong Aspose.Words cho Java
...
## 9. Thông tin bản quyền ở chân trang
...
```java
        ...
        // Khoảng cách từ cạnh trên/trái của trang được đặt là 10 điểm.
        builder.insertImage(getImagesDir() + "Graphics Interchange Format.gif", RelativeHorizontalPosition.PAGE, 10.0,
            RelativeVerticalPosition.PAGE, 10.0, 50.0, 50.0, WrapType.THROUGH);
...
```java
    /// <tóm tắt>
    //Sao chép và sao chép phần đầu trang/chân trang từ phần trước vào phần đã chỉ định.
    /// </tóm tắt>
