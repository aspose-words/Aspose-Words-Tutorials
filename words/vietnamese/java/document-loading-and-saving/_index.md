...
### [Cách tải tệp từ thư mục bằng Aspose.Words trong C#](./how-to-load-file-from-directory-using-aspose-words-in-c/)
Học cách tải tệp từ thư mục bằng Aspose.Words trong C#.
