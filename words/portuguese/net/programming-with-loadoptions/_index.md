...
| [Recuperar docx danificado com Aspose.Words – definir modo de recuperação e opções de carregamento](./recover-damaged-docx-with-aspose-words-set-recovery-mode-and/) Aprenda a definir o modo de recuperação e usar LoadOptions para restaurar arquivos DOCX corrompidos com Aspose.Words para .NET. |
