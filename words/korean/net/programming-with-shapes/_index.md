...
| [C#에서 도형에 그림자 설정하기 – 완전한 Aspose.Words 가이드](./how-to-set-shadow-on-shapes-in-c-complete-aspose-words-guide/) | C#와 Aspose.Words를 활용해 Word 도형에 그림자를 설정하는 전체 가이드를 제공합니다. |
