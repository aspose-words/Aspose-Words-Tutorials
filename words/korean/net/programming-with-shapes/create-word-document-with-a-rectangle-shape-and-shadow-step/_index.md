...
category: general
date: 2026-03-01
description: Aspose.Words를 사용하여 워드 문서를 만들고, 사각형 도형 추가 방법, 그림자 추가 방법, 투명도 설정 방법, 그리고
  도형 생성 방법을 모두 C#로 배우세요.
draft: false
keywords:
...
language: ko
og_description: C#에서 Aspose.Words를 사용해 워드 문서를 만들고, 사각형 모양을 추가하고 외부 그림자를 적용하며 투명도를
  설정하는 방법을 몇 단계만에 배워보세요.
og_title: 사각형 도형과 그림자를 사용한 워드 문서 만들기 – 가이드
tags:
- Aspose.Words
- C#
- Document Generation
title: 직사각형 도형과 그림자가 있는 워드 문서 만들기 – 단계별 가이드
url: /ko/net/programming-with-shapes/create-word-document-with-a-rectangle-shape-and-shadow-step/
---
...
# Word 문서에 사각형 모양과 그림자 만들기 – 단계별 가이드
