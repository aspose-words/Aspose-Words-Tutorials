...
category: general
date: 2026-08-07
description: C#에서 AI 문서 번역을 사용해 docx를 프랑스어로 번역하세요. 대상 언어 설정 방법, 워드 문서 번역 방법, 그리고 문서를
  효율적으로 일괄 번역하는 방법을 배워보세요.
draft: false
images:
...
language: ko
lastmod: 2026-08-07
og_description: AI를 사용하여 docx를 프랑스어로 번역합니다. 이 가이드는 대상 언어 설정, 워드 문서 번역, 그리고 C#를 사용한
  문서 일괄 번역 방법을 보여줍니다.
og_image_alt: Screenshot of C# code translating a DOCX file to French
og_title: AI로 docx를 프랑스어로 번역 – 완전 C# 가이드
schemas:
- author: GroupDocs
...
- AI translation
- Office automation
title: C#에서 AI를 사용해 docx를 프랑스어로 번역하기
url: /ko/net/ai-powered-document-processing/translate-docx-to-french-with-ai-in-c/
---
...
# C#에서 AI를 사용하여 docx를 프랑스어로 번역하기
