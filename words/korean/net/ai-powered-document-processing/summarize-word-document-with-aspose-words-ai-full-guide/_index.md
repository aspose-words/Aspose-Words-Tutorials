...
category: general
date: 2026-07-29
description: Aspose.Words AI를 사용하여 Word 문서를 요약합니다. API 키 환경 설정 방법과 C#에서 보고서의 요약을 추출하는
  완전하고 실행 가능한 예제를 배워보세요.
draft: false
images:
...
language: ko
lastmod: 2026-07-29
og_description: Word 문서를 즉시 요약하세요. 이 가이드는 API 키 환경을 설정하고 Aspose.Words AI를 사용하여 보고서에서
  요약을 추출하는 방법을 보여줍니다.
og_image_alt: Diagram illustrating summarize word document workflow with Aspose.Words
  AI
og_title: Aspose.Words AI를 사용한 Word 문서 요약 – 완전한 C# 튜토리얼
schemas:
- author: Aspose
...
- C#
- AI summarization
title: Aspose.Words AI로 워드 문서 요약 – 전체 가이드
url: /ko/net/ai-powered-document-processing/summarize-word-document-with-aspose-words-ai-full-guide/
---
...
# Aspose.Words AI를 사용한 Word 문서 요약 – 전체 가이드
...
A: 현재 `DocumentSummarizer`는 톤을 직접 지정하는 옵션을 제공하지 않지만, 프롬프트에 “formal tone” 또는 “casual tone”과 같은 지시문을 포함시켜 원하는 스타일을 유도할 수 있습니다.
