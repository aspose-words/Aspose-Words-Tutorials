...
## 1단계: Word 문서 불러오기 - **Word 문서를 Markdown으로 변환**의 시작점
...
## 2단계: 리소스 절약 콜백을 사용하여 MarkdownSaveOptions 설정
...
## 3단계: 문서를 Markdown으로 저장 - **Word 문서를 Markdown으로 저장**하는 마지막 단계
