...
| [Word에서 LaTeX 내보내기 – DOCX를 Markdown으로 변환](./how-to-export-latex-from-word-convert-docx-to-markdown/) | Aspose.Words for .NET을 사용하여 Word 문서에서 LaTeX 수식을 추출하고 DOCX를 Markdown으로 변환하는 방법을 단계별로 안내합니다. |
| [Word에서 Markdown 저장 – 전체 가이드](./how-to-save-markdown-from-word-complete-guide/) | Aspose.Words for .NET을 사용하여 Word 문서를 Markdown으로 저장하는 전체 단계별 C# 가이드 |
