...
| [Word를 Markdown으로 저장 – Aspose.Words로 표를 HTML로 내보내기](./save-word-as-markdown-export-tables-to-html-with-aspose-word/) | Aspose.Words를 사용하여 Word 문서의 표를 HTML로 내보내면서 Markdown으로 저장하는 방법을 단계별로 안내합니다. |
