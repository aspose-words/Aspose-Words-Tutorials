...
### [Java에서 Aspose.Words로 글꼴 대체 경고 기록 – 완전 가이드](./log-font-substitution-warnings-in-java-with-aspose-words/)
### [Java에서 손상된 DOCX 복구 – 완전 프로그래밍 가이드](./recover-corrupted-docx-in-java-complete-programming-guide/)
