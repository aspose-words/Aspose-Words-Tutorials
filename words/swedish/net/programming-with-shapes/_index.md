...
| [Hur man infogar tagg och skapar en gruppform i en DOCX](./how-to-insert-tag-and-create-a-group-shape-in-a-docx/) | Lär dig hur du infogar tagg och skapar en gruppform i ett DOCX‑dokument med Aspose.Words för .NET. |
| [Hur man döljer en form i ett Word-dokument med C#‑kod](./how-to-hide-shape-in-a-word-document-with-c-code/) | Lär dig hur du döljer en form i ett Word‑dokument med Aspose.Words för .NET och C#. |
